...
import { XaiRealtimeVoiceLifecycle } from "./realtime-voice-lifecycle.js";

describe("XaiRealtimeVoiceLifecycle", () => {
  it("moves a connection from idle through ready", () => {
    const lifecycle = new XaiRealtimeVoiceLifecycle();
