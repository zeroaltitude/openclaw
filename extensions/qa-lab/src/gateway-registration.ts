...
import { QA_SESSION_OBSERVER_HEADER } from "./providers/shared/session-observer-registry.js";
import { createQaLabWebSearchProvider } from "./qa-web-search-provider.js";
...
export const qaLabGatewayDefinition = {
  id: "qa-lab",
  name: "QA Lab",
