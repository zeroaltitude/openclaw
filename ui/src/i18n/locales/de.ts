...
export const de: TranslationMap = {
  common: {
    ...
    staleData: "Veraltete Daten werden angezeigt.",
    reload: "Neu laden",
    reset: "Zurücksetzen",
  ...
  channels: {
    ...
    pairing: {
      title: "DM-Zugriffsanfragen",
      subtitle:
        "Prüfen Sie Personen, die auf das Senden von Direktnachrichten an pairing-geschützte Kanäle warten.",
      channelFilter: "Kanal",
      accountFilter: "Konto",
      ...
      approve: "Genehmigen",
      dismiss: "Verwerfen",
      approveAria: "{sender} für {channel} genehmigen, Konto {account}",
      dismissAria: "{sender} für {channel} verwerfen, Konto {account}",
      requested: "Angefragt {ago}",
      expires: "Läuft ab {ago}",
      senderDetails: "Absenderdetails",
      missingPermission:
        "Diese Verbindung hat keinen operator.pairing-Zugriff, daher können DM-Anfragen nicht geprüft werden.",
      noAccounts: "Keine konfigurierten Kanalkonten verwenden DM-Absender-Pairing.",
      noRequests: "Keine ausstehenden DM-Zugriffsanfragen.",
      noFilteredRequests: "Keine ausstehenden Anfragen entsprechen diesen Filtern.",
      limits:
        "Anfragen laufen nach {minutes} Minuten ab. Jedes Kanalkonto kann bis zu {count} ausstehende Anfragen halten.",
      detailTitle: "DM-Zugriff",
      detailSubtitle:
        "Personen müssen bestätigt werden, bevor ihre Direktnachrichten den Agenten erreichen.",
      pendingCount: "{count} ausstehend",
      noPending: "Keine ausstehenden Anfragen",
      review: "Anfragen prüfen",
      approveDialogTitle: "DM-Zugriff genehmigen",
      dismissDialogTitle: "DM-Zugriffsanfrage verwerfen",
      approveExplanation:
        "Dadurch kann der Absender in Direktnachrichten mit dem Agenten sprechen. Es wird kein Gruppenzugriff gewährt.",
      dismissExplanation:
        "Dadurch wird die aktuelle Anfrage entfernt, der Absender wird jedoch nicht blockiert. Er kann den Zugriff später erneut anfragen.",
      notifyRequester: "Anfragenden nach der Genehmigung benachrichtigen",
      makeCommandOwner: "Diesen Absender auch zum ersten Befehlsinhaber machen",
      commandOwnerHelp:
        "Befehlsinhaber können privilegierte Befehle ausführen und gefährliche Aktionen genehmigen. Diese Option ist nur verfügbar, solange kein Inhaber konfiguriert ist.",
      commandOwnerNeedsAdmin:
        "Es ist kein Befehlsinhaber konfiguriert. Diese Verbindung benötigt operator.admin, um den ersten Inhaber zuzuweisen.",
      approvedNotice: "DM-Zugriff genehmigt.",
      approvedOwnerNotice: "DM-Zugriff genehmigt und der erste Befehlsinhaber wurde konfiguriert.",
      approvedNotificationFailedNotice:
        "DM-Zugriff genehmigt, aber die Benachrichtigung des Anfragenden konnte nicht zugestellt werden.",
      approvedOwnerFailedNotice:
        "DM-Zugriff genehmigt, aber der erste Befehlsinhaber konnte nicht konfiguriert werden.",
      approvedFollowupsFailedNotice:
        "DM-Zugriff genehmigt, aber sowohl die Benachrichtigung des Anfragenden als auch die Einrichtung des Befehlsinhabers sind fehlgeschlagen.",
      dismissedNotice:
        "DM-Zugriffsanfrage verworfen. Der Absender kann den Zugriff erneut anfragen.",
    },
    setup: {
      ...
      working: "Arbeitet…",
      sessionExpired:
        "Diese Einrichtungssitzung ist nach dem Neustart des Gateway abgelaufen. Schließen Sie diesen Dialog und starten Sie die Kanaleinrichtung erneut.",
      continue: "Weiter",
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Möglicherweise ist sie bereits nicht mehr vorhanden oder das Auth-Verzeichnis muss manuell bereinigt werden.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Noch keine App?",
      getApps: "Apps herunterladen",
  ...
  agentChip: {
    ...
    agents: "Agents",
    openChat: "Mit {name} chatten",
    offlineOpenSettings: "Offline – Einstellungen öffnen",
  ...
  newSession: {
    ...
    cloudWorkerProvider: "Cloud-Worker-Anbieter: {provider}",
    cloudRequiresWorktree: "Cloud-Worker erfordern einen verwalteten Worktree",
    cloudRequiresOpenClawRuntime:
      "Cloud-Worker benötigen die OpenClaw-Laufzeit; {runtime} ist ausgewählt.",
    ...
    places: "Orte",
    recentFolders: "Zuletzt verwendet",
    runsOn: "Läuft auf {place}",
  ...
  sessionsView: {
    ...
    global: "Global",
    unknown: "Unbekannt",
    sessionState: "Thread-Status",
    all: "Alle",
    sessionArchived: "Thread archiviert",
    sessionsArchived: "{count} Threads archiviert",
    deleteAllArchived: "Alle archivierten löschen…",
    deleteAllArchivedConfirm: "{count} archivierte Threads und ihre Transkripte löschen?",
    ...
    queuedMessage: "{count} Nachricht zum Senden in Warteschlange",
    queuedMessages: "{count} Nachrichten zum Senden in Warteschlange",
    ...
    runFailedReason: "Ausführung fehlgeschlagen: {reason}",
    ...
    showChildSessions: "{count} untergeordnete Sitzungen für {session} anzeigen",
    hideChildSessions: "{count} untergeordnete Sitzungen für {session} ausblenden",
    childSessions: "Untergeordnete Sitzungen",
    showMoreChildren: "{count} weitere anzeigen",
    archived: "Archiviert",
    pinned: "Angeheftet",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Cloud-Worker-Kind: 1 Workspace-Konflikt",
    cloudWorkerDescendantConflicts: "Cloud-Worker-Kinder: {count} Workspace-Konflikte",
    ...
    invalidEmojiIcon: "Genau ein Emoji eingeben.",
    ...
    stopCloudWorker: "Cloud-Worker stoppen…",
    stopCloudWorkerConfirm: "Den Cloud-Worker für „{session}“ stoppen?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Ihr Gateway-Profil",
      assistantIdentity: "Assistenten-Identität",
      displayName: "Anzeigename",
      displayNamePlaceholder: "Ihr Name",
      saveProfile: "Name speichern",
      saving: "Wird gespeichert…",
      uploading: "Wird verarbeitet…",
      profileHint:
        "JPEG, PNG oder WebP. Bilder werden zentriert zugeschnitten und auf 512px skaliert.",
      profileLoadFailed: "Ihr Profil konnte nicht geladen werden.",
      profileSaveFailed: "Ihr Profil konnte nicht gespeichert werden.",
      avatarInvalid: "Wählen Sie ein gültiges JPEG-, PNG- oder WebP-Bild.",
      avatarTooLarge: "Der verarbeitete Avatar ist immer noch zu groß.",
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway auf Ihren Geräten synchronisiert.",
    notifications: {
      title: "Push-Benachrichtigungen",
      nativeTitle: "Benachrichtigungen",
      hint: "Erhalte Browser-Push-Benachrichtigungen von deinem Gateway.",
      nativeHint: "Benachrichtigungen werden von der OpenClaw-App auf diesem Mac nativ angezeigt.",
    ...
    sidebarPrefs: {
      title: "Seitenleiste",
      hint: "Wähle aus, was während laufender Sitzungen angezeigt wird.",
      liveActivity: "Live-Agentenaktivität in der Seitenleiste anzeigen",
      liveActivityHint:
        "Zeige die neueste Assistenten- oder Tool-Aktivität unter laufenden Sitzungen an.",
    },
    sessionObserver: {
      title: "Sitzungsbeobachter",
      hint: "Fasse langlaufende Sitzungen mit einem kleinen Hilfsmodell zusammen.",
      toggle: "Sitzungsbeobachter",
      toggleHint: "Erstelle Live-Statuszusammenfassungen für abonnierte Control-UI-Sitzungen.",
      ...
      auto: "Auto (Anbieterstandard)",
      disabled: "Deaktiviert",
      toggleNote: "Control-UI-Sitzungsbeobachter aktualisieren",
    ...
    rawDraftPendingFormTitle:
      "Ungespeicherte Raw-Konfigurationsänderungen — speichern oder verwerfen Sie diese, bevor Sie zum Formular wechseln.",
    rawDraftBlocksFormEdit:
      "Ungespeicherte Raw-Konfigurationsänderungen konnten nicht verarbeitet werden; beheben Sie diese im Raw-Editor, bevor Sie Einstellungen ändern.",
    invalidConfig:
    ...
    formUnsafeCount:
      "1 Einstellung in dieser Konfiguration kann nur als Text bearbeitet werden: {paths}",
    formUnsafeCountPlural:
      "{count} Einstellungen in dieser Konfiguration können nur als Text bearbeitet werden: {paths}",
    formUnsafeMore: "+{count} weitere",
    openRawEditor: "Raw-Editor öffnen",
  ...
  execApproval: {
    ...
    otherPending: "Weitere ausstehende Anfragen",
    reviewRequest: "Freigabe von {agent} prüfen: {command}",
    agentPendingOne: "{count} ausstehende Genehmigung",
    agentPending: "{count} ausstehende Genehmigungen",
  ...
  nav: {
    ...
    settingsGroupSecurity: "Datenschutz & Sicherheit",
  ...
  terminal: {
    ...
    noSessions: "Keine aktiven Terminalsitzungen",
    currentSession: "aktuell",
    sessionAttached: "verbunden",
  ...
  subtitles: {
    ...
    apps: "Begleit-Apps für Smartphone, Uhr, Desktop und Browser.",
    ...
    modelSetup: "Ein verifiziertes KI-Modell verbinden",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Codex- und Claude Code-Speicher in einen Agenten-Arbeitsbereich importieren.",
    notifications: "Browser-Push-Benachrichtigungen von deinem Gateway.",
    security: "Gateway-Authentifizierung, Exec-Richtlinie, Tool-Profil und Freigaben.",
    advanced: "Alle übrigen Konfigurationsabschnitte sowie der Rohdatei-Editor.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      recommended: "Empfohlen",
      credentialsReady: "Anmeldedaten verfügbar",
      signInNeeded: "Anmeldung erforderlich",
      detected: "Erkannt",
    ...
    prepare: {
      ...
      llamaCppHint: "Lade ein etwa 5,0 GB großes lokales Modell herunter; erfordert 16 GB RAM",
    },
    manual: {
    ...
    failure: {
      ...
      rateLimit: "Ratenlimit erreicht",
      billing: "Abrechnungsproblem",
      timeout: "Zeitüberschreitung",
      format: "Ungültige Antwort",
      unavailable: "Nicht verfügbar",
      unknown: "Verbindung fehlgeschlagen",
    },
    errors: {
      requestFailed: "Die Anfrage zur Modelleinrichtung ist fehlgeschlagen.",
      activationFailed: "Das Modell konnte nicht aktiviert werden.",
    },
    wizard: {
      dialogLabel: "Anmeldung beim Anbieter",
      prepareDialogLabel: "Einrichtung des lokalen Modells",
      title: "Bei einem Anbieter anmelden",
      prepareTitle: "Ein lokales Modell einrichten",
      ...
      continue: "Weiter",
      submit: "Absenden",
      openSignIn: "Anmeldeseite öffnen",
      copy: "Kopieren",
      expires: "Läuft in {count} Minuten ab",
      cancelled: "Die Anmeldung beim Anbieter wurde abgebrochen.",
      sessionExpired:
        "Diese Einrichtungssitzung ist nach dem Neustart des Gateway abgelaufen. Schließe diesen Dialog und starte dann die Modelleinrichtung erneut.",
      notComplete:
        "Die Anmeldung wurde abgeschlossen, aber die Modelleinrichtung ist noch nicht vollständig.",
    },
  },
  memoryImport: {
    unknownCollection: "Speichersammlung",
    claudeCode: "Claude Code",
    fileCountOne: "{count} Datei",
    fileCount: "{count} Dateien",
    alreadyImported: "{count} vorhanden",
    ready: "Bereit",
    existing: "Vorhanden",
    importComplete: "Import abgeschlossen",
    importIncomplete: "Import unvollständig",
    importedCount: "{count} Dateien importiert",
    importedWithIssues: "{migrated} importiert · {errors} fehlgeschlagen · {conflicts} Konflikte",
    reportSaved: "Bericht gespeichert",
    recoveryFile: "Wiederherstellungsdatei",
    recoveryJournal: "Wiederherstellungsjournal",
    itemBackup: "Elementsicherung",
    codexDescription: "Konsolidierte Codex-Speicherdateien.",
    claudeDescription: "Projektspezifische automatische Speicherdateien von Claude Code.",
    providerFallback: "Assistentenspeicher in diesen Agenten-Arbeitsbereich importieren.",
    reviewFiles: "Dateien überprüfen",
    notFound: "Nicht gefunden",
    noMemoryFound: "Auf diesem Computer wurde kein importierbarer Speicher gefunden.",
    source: "Quelle",
    destination: "Ziel",
    selectedCount: "{count} ausgewählt",
    selectAtLeastOne: "Mindestens eine Datei auswählen",
    importSelected: "Ausgewählte importieren",
    confirmTitle: "Aus {provider} importieren?",
    confirmDescription:
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Dein Leitfaden zur Systemeinrichtung",
    subtitleCaretaker: "Systemeinrichtung und Pflege.",
    exitSetup: "Einrichtung beenden",
    newAgent: "Neuer Agent",
    hatchDraft: "Wach auf, mein Freund!",
    placeholder: "Nachricht an OpenClaw …",
    sensitivePlaceholder: "Sensiblen Wert eingeben …",
    sensitiveReply: "Sensible Antwort gesendet",
    send: "Senden",
    thinking: "OpenClaw denkt nach",
    earlier: "Früher",
    requestFailed: "OpenClaw konnte nicht antworten. Versuche es erneut.",
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Wiederhole, um diese Einrichtung fortzusetzen.",
    sessionRestarted:
      "{error} OpenClaw hat eine neue Sitzung gestartet; frühere Nachrichten bleiben als Kontext erhalten.",
    unsupportedGateway: "Aktualisiere das Gateway, um die Einrichtung mit OpenClaw fortzusetzen.",
    history: {
      button: "Verlauf",
      title: "Letzte Änderungen",
      description: "Was sich auf diesem System geändert hat, neueste zuerst.",
      loading: "Letzte Änderungen werden geladen …",
      empty: "Noch keine aufgezeichneten Änderungen.",
      requestFailed: "OpenClaw konnte den Änderungsverlauf nicht laden.",
      loadMore: "Mehr laden",
      loadingMore: "Mehr wird geladen …",
      changedPaths: "Geänderte Pfade ({count})",
      invalidEdit: "Diese manuelle Änderung hat die Konfigurationsvalidierung nicht bestanden.",
      opaqueChange:
        "Formatierung oder Kommentare wurden ohne sichtbare Änderungen an Konfigurationspfaden geändert.",
      sources: {
        ...
        manualEdit: "manuelle Bearbeitung",
        unknown: "unbekannt",
      },
    },
    nudge: {
      configReload: "Neuladen der Konfiguration gestoppt – frag mich, was passiert ist",
      channelAuth: "{channel}-Authentifizierung beeinträchtigt – frag mich, was passiert ist",
      channelDisconnected: "{channel} wurde gerade getrennt – frag mich, was passiert ist",
  ...
  mcpServers: {
    ...
    addedSuccess: "MCP-Server {name} hinzugefügt.",
    enabledSuccess: "MCP-Server {name} aktiviert.",
    disabledSuccess: "MCP-Server {name} deaktiviert.",
    removedSuccess: "MCP-Server {name} entfernt.",
    configUnavailable: "Konfiguration ist nicht verfügbar; aktualisieren und erneut versuchen.",
    connectRequired: "Verbinden Sie sich mit dem Gateway, um MCP-Server zu ändern.",
    adminRequired: "Änderungen an MCP-Servern erfordern operator.admin-Zugriff.",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Releases ändern, ausfallen oder verschwinden können.",
    sectionTitle: "Experimentelle Funktionen",
    sectionDescription:
      "Änderungen werden sofort gespeichert und gelten für zukünftige Agent-Läufe.",
    documentation: "Dokumentation",
    restartRequired: "Gateway-Neustart erforderlich.",
    saveErrorTitle: "Funktion konnte nicht aktualisiert werden",
    saveFailed: "Die Funktionseinstellung konnte nicht gespeichert werden.",
    codeMode: {
      title: "Code Mode",
      description:
        "Lassen Sie Agenten Tools in kompakten, isolierten JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "Nehmen Sie OpenClaw überallhin mit",
    heroTagline:
      "Begleit-Apps für Ihr Smartphone, Ihre Uhr, Ihren Desktop und Ihren Browser – dazu Plugins, um die Fähigkeiten Ihres Agenten zu erweitern.",
    sectionMobile: "Auf Ihrem Smartphone",
    havePhone: "Sie haben die App bereits?",
    pairDevice: "Gerät koppeln",
    sectionWatch: "An Ihrem Handgelenk",
    sectionDesktop: "Auf Ihrem Desktop",
    sectionBrowser: "In Ihrem Browser",
    sectionCommunity: "Community",
    badgeBundledIos: "In der iOS-App enthalten",
    badgeBundledAndroid: "In der Android-App enthalten",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Herunterladen",
    ctaDocs: "Dokumentation",
    ctaSetupGuide: "Einrichtungsanleitung",
    ctaOpenPlugins: "Plugins öffnen",
    ctaBrowseClawHub: "ClawHub durchsuchen",
    linkDiscord: "Discord-Community",
    linkDocs: "Dokumentation",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatten, sprechen, Aktionen genehmigen und aus iOS in OpenClaw teilen.",
      },
      android: {
        title: "Android",
        desc: "Dein Android-Telefon als vollständiger OpenClaw-Knoten – Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats auf einen Blick und schnelle Antworten direkt vom Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Der Android-Begleiter erweitert OpenClaw auf deine Uhr.",
      },
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleiter für dein Gateway – Benachrichtigungen, Genehmigungen, schneller Chat.",
      },
      windows: {
        title: "Windows",
        desc: "Die Windows-Begleit-App verbindet Ihren PC als OpenClaw-Node.",
      },
      linux: {
        title: "Linux",
        desc: "Native Desktop-App – .deb- und AppImage-Builds.",
      },
      chrome: {
        title: "Chrome-Erweiterung",
        desc: "Lassen Sie OpenClaw Ihr vorhandenes Chrome steuern – Tabs, Seiten und Formulare.",
      },
      plugins: {
        title: "Plugins & ClawHub",
        desc: "Erweitern Sie OpenClaw mit Kanälen, Tools und Skills aus der Community.",
      },
    },
  },
  presence: {
    rosterLabel: "Anzeigen, wer online ist",
    rosterTitle: "Online",
    serverRegion: "Server",
    you: "Sie",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Identität ist nicht festgelegt.",
      setIdentity: "Identität festlegen",
      avatar: "Avatar",
      avatarDescription: "PNG, JPEG oder WebP. Bilder werden auf 256 × 256 oder kleiner skaliert.",
      chooseAvatar: "Bild auswählen",
      processingAvatar: "Wird verarbeitet…",
      displayName: "Anzeigename",
      displayNameDescription: "Wird anderen Personen angezeigt, die dieses Gateway nutzen.",
      linkedEmails: "Verknüpfte E-Mails",
      linkedEmailsDescription: "Mit diesem Profil verbundene E-Mail-Adressen.",
      openSettings: "Identitätseinstellungen für {name} öffnen",
      avatarErrors: {
        invalid: "Dieses Bild konnte nicht verarbeitet werden.",
        sourceTooLarge: "Wähle ein Bild, das 10 MB oder kleiner ist.",
        tooLarge: "Der verarbeitete Avatar ist größer als 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    ...
    exportButton: "{label} exportieren",
    exportLabels: {
      filtered: "gefiltert",
      visible: "sichtbar",
    },
    ...
    autoFollow: "Automatisch folgen",
    file: "Datei: {file}",
    truncated: "Protokollausgabe gekürzt; neuester Abschnitt wird angezeigt.",
  ...
  board: {
    ...
    moreTabs: "Weitere Dashboard-Tabs",
    gridLabel: "Dashboard-Widgets",
    emptyTitle: "Ein leeres Board, bereit für die Arbeit",
    emptyHint:
      "Ihr Agent kann hier Widgets anheften – fragen Sie zum Beispiel nach einer Statuskarte.",
    actionFailed: "Die Dashboard-Änderung konnte nicht gespeichert werden.",
    actionInProgress: "Eine andere Dashboard-Änderung wird noch gespeichert.",
    announcement: {
      moved: "{title} verschoben.",
      resized: "Größe von {title} geändert.",
      removed: "{title} entfernt.",
      granted: "Widget-Zugriff erlaubt.",
      rejected: "Widget-Zugriff abgelehnt.",
    },
    widget: {
      cellLabel:
        "Dashboard-Widget: {title}. Verwenden Sie die Pfeiltasten zur Navigation. Halten Sie Alt gedrückt und drücken Sie eine Pfeiltaste, um es zu verschieben.",
      moveHandle: "{title} verschieben",
      resizeHandle: "Größe von {title} ändern",
      menuLabel: "Widget-Optionen",
      moveToTab: "In Tab verschieben",
      noOtherTabs: "Keine anderen Tabs",
      resize: "Größe ändern",
      ...
      retry: "Erneut versuchen",
      frameResolverMissing: "Widget-Inhalt ist nicht verfügbar.",
      ...
      sandboxOriginRequired:
        "Die Widget-Autorisierung ist nach wiederholten Aktualisierungsversuchen fehlgeschlagen. Wenn das Gateway hinter einem Reverse-Proxy oder Tunnel läuft, der den Widget-Sandbox-Port nicht weiterleitet, setze mcp.apps.sandboxOrigin auf einen dedizierten öffentlichen Ursprung, der zum Sandbox-Listener geleitet wird.",
      errorTitle: "Dieses Widget konnte nicht geladen werden",
      errorDetail: "Das Problem bleibt auf diese Karte beschränkt.",
      actionErrorTitle: "Widget-Änderung fehlgeschlagen",
      actionErrorDetail: "Das Dashboard hat den vorherigen Widget-Status beibehalten.",
      errorShow: "Details anzeigen",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Plugin-Widget wird geladen…",
      disabledPlugin: "Widget vom deaktivierten Plugin {pluginId}",
    },
  },
  workboard: {
    widget: {
      ...
      cardIdRequired: "Dieses Widget benötigt eine cardId-Eigenschaft.",
    ...
    dashboardEmpty: "Noch kein Dashboard — der arbeitende Agent kann Widgets anheften.",
    openSession: "Sitzung öffnen",
  ...
  modelProviders: {
    ...
    credentials: {
      ...
      envKey: "API-Schlüssel aus der Umgebung",
      envKeyNamed: "API-Schlüssel aus der Umgebung ({name})",
      profileKey: "API-Schlüsselprofile: {count}",
      none: "Nicht konfiguriert",
    },
    apiKey: {
      label: "API-Schlüssel",
      placeholder: "API-Schlüssel des Anbieters eingeben",
      replacePlaceholder:
        "Geheimnis gespeichert. Geben Sie einen neuen Schlüssel ein, um ihn zu ersetzen.",
      set: "API-Schlüssel festlegen",
      replace: "Schlüssel ersetzen",
      remove: "Schlüssel entfernen",
      saved: "Geheimnis gespeichert.",
      removed: "API-Schlüssel entfernt.",
      authModeBlocked:
        "Änderungen am API-Schlüssel sind nicht verfügbar, solange der Authentifizierungsmodus „{mode}“ lautet.",
    },
    probe: {
      test: "Verbindung testen",
      testing: "Wird getestet…",
      unavailable: "Für den Verbindungstest ist ein neueres Gateway erforderlich.",
      latency: "{ms} ms",
      status: {
        ok: "Verbunden",
        auth: "Authentifizierung fehlgeschlagen",
        rate_limit: "Ratenlimit erreicht",
        billing: "Abrechnungsproblem",
        timeout: "Zeitüberschreitung",
        format: "Ungültige Antwort",
        unknown: "Verbindung fehlgeschlagen",
    ...
    logout: {
      action: "Abmelden",
      confirm: "Von {provider} abmelden? Gespeicherte OAuth- und Tokenprofile werden entfernt.",
    ...
    add: {
      ...
      subtitle:
        "Wählen Sie einen bekannten Modellanbieter aus und speichern Sie dessen API-Schlüssel.",
      action: "Anbieter hinzufügen",
      none: "Alle bekannten Anbieter sind bereits konfiguriert.",
      provider: "Anbieter",
      selectProvider: "Anbieter auswählen",
      save: "Anbieter speichern",
      saved: "Anbieter {provider} hinzugefügt.",
    },
    defaults: {
      title: "Standardmodelle",
      subtitle: "Wählen Sie das primäre Modell, geordnete Ausweichmodelle und das Hilfsmodell aus.",
      primary: "Standardmodell",
      utility: "Hilfsmodell",
      automatic: "Automatisch (Anbieterstandard)",
      disabled: "Deaktiviert",
      savedSelection: "Gespeicherte Auswahl",
      fallbacks: "Fallbacks",
      noFallbacks: "Keine Ausweichmodelle konfiguriert.",
      unsaved: "Nicht gespeicherte Änderungen",
      addFallback: "Ausweichmodell hinzufügen",
      selectModel: "Modell auswählen",
      selectFallback: "Ausweichmodell auswählen",
      noModels: "Konfigurieren Sie einen Anbieter, bevor Sie Standardmodelle auswählen.",
      saved: "Standardmodelle gespeichert.",
    },
    readOnly: {
      disconnected:
        "Stellen Sie eine Verbindung zum Gateway her, um die Modelleinstellungen zu ändern.",
      adminRequired: "Nur Ansicht. Modelländerungen erfordern operator.admin-Zugriff.",
    },
    notes: {
      saveKey: "API-Schlüssel für {provider} über die Control UI speichern",
      removeKey: "API-Schlüssel für {provider} über die Control UI entfernen",
      addProvider: "Modellanbieter {provider} über die Control UI hinzufügen",
      defaultModel: "Standardmodellauswahl über die Control UI aktualisieren",
    },
  },
  usage: {
    common: {
    ...
    details: {
      ...
      loadFailed: "{detail} konnte nicht geladen werden: {error}",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Dieser veraltete Browser bleibt vorübergehend verfügbar. Öffne ihn erneut über HTTPS oder localhost, um ihn mit einer Geräteidentität abzusichern.",
      pendingUnavailable:
        "Die Browser-Kopplungsanfrage ist noch nicht verfügbar. Versuche es gleich noch einmal.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Der Thread hat den Zweig gewechselt — überprüfe und sende erneut.",
    },
    ...
    sessionHeader: {
      ...
      untitledBranch: "Unbenannter Branch",
    ...
    board: {
      ...
      dockLeft: "Chat links andocken",
      dockRight: "Chat rechts andocken",
      dockBottom: "Chat unten andocken",
      dockHidden: "Chat ausblenden",
      resizeDock: "Chat-Dock-Größe ändern",
      reopenChat: "Chat anzeigen",
      workboardCard: "Workboard-Karte: {title}, {status}",
      defaultTab: "Haupt",
      mockPlaceholder: "Board-Ansicht · {tabs} Tabs · {widgets} Widgets",
      mockOverview: "Übersicht",
      mockResearch: "Recherche",
      mockSessionStatus: "Thread-Status",
      mockRecentFindings: "Aktuelle Erkenntnisse",
      mockSourceMap: "Quellenkarte",
      resetTitle: "Unterhaltung zurücksetzen?",
      resetDescription:
        "Der Unterhaltungskontext wird zurückgesetzt. Dein Dashboard bleibt erhalten.",
    },
    catalog: {
      remoteViewOnly:
    ...
    workspaceConflict: {
      ...
      titleMany: "{count} Cloud-Workspace-Konflikte",
      description:
        "OpenClaw hat deine lokalen Versionen beibehalten und die anderen Cloud-Änderungen übernommen. Prüfe das bereitgestellte Ergebnis oder übernimm dessen Version für einen konfliktbehafteten Pfad.",
      morePaths: "+{count} weitere Pfade",
      stagedResult: "Bereitgestelltes Cloud-Ergebnis",
      copyStagedResult: "Referenz des bereitgestellten Ergebnisses kopieren",
      inspectCloud: "Erste Cloud-Version prüfen",
      takeCloud: "Erste Cloud-Version übernehmen",
      copyInspectCommand: "Cloud-Inspect-Befehl kopieren",
      copyTakeCommand: "Take-Cloud-Befehl kopieren",
      commandHelp:
        "Führen Sie diese in Bash oder zsh aus (Git Bash unter Windows). Wenn inspect meldet, dass der Pfad nicht existiert, hat die Cloud ihn gelöscht; überprüfen Sie das und entfernen Sie den lokalen Pfad manuell. Wenn checkout einen Datei-/Verzeichniskonflikt meldet, verschieben oder entfernen Sie den blockierenden lokalen Pfad und versuchen Sie es erneut. Wenn die bereitgestellte Referenz fehlt, ist der Hinweis veraltet; ändern Sie den lokalen Pfad nicht.",
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen, sodass OpenClaw dafür keinen kopierbaren Shell-Befehl erstellt. Überprüfen Sie die bereitgestellte Referenz direkt und geben Sie den Pfad sorgfältig manuell ein.",
      dismiss: "Hinweis auf Workspace-Konflikt schließen",
      eventSender: "Cloud-Workspace",
      eventTitleOne: "Cloud-Ergebnis mit 1 Konflikt angewendet",
      eventTitleMany: "Cloud-Ergebnis mit {count} Konflikten angewendet",
      eventDescription:
        "Für diese Pfade wurden lokale Versionen beibehalten; andere Cloud-Änderungen wurden angewendet.",
    },
    compaction: {
    ...
    progressLabels: {
      ...
      sifting: "Siebend",
      brining: "Pökelnd",
      nautiling: "Nautilierend",
      krilling: "Krillend",
      barnacling: "Rankenfüßernd",
      lobstering: "Hummernd",
      tidepooling: "Gezeitentümpelnd",
      pearling: "Perlend",
      snapping: "Schnappend",
    ...
    questions: {
      ...
      collapse: "Frage einklappen",
      expand: "Frage ausklappen",
      eyebrow: "Frage",
      cardLabel: "Frage vom Assistenten",
      summaryLabel: "Frageergebnis",
      timeRemaining: "Verbleibende Zeit",
      ownAnswer: "Ihre eigene Antwort…",
      ownAnswerFor: "Deine eigene Antwort für {header}",
    ...
    messages: {
      ...
      hideTooltip: "Nur in diesem Browser ausblenden",
      ...
      rewindUnavailable: "Zurückspulen ist nicht verfügbar, während der Agent arbeitet",
      forkUnavailable: "Fork ist nicht verfügbar, während der Agent arbeitet",
    ...
    rail: {
      ...
      subtitle: "Fragen zu dieser Sitzung oder ihrem Projekt stellen",
      expand: "Sitzungsleiste erweitern",
      collapse: "Sitzungsleiste einklappen",
      hide: "Sitzungsleiste ausblenden",
      show: "Sitzungsleiste anzeigen",
      clear: "Begleiter-Thread löschen",
      plan: "Plan",
      progress: "{completed} von {total}",
      pullRequests: "Pull Requests",
      checksPassing: "{count} bestanden",
      checksFailing: "{count} fehlgeschlagen",
      checksPending: "{count} laufen",
      finished: "Abgeschlossen {time}",
      empty: "Stelle eine schreibgeschützte Frage zu dieser Sitzung oder ihrem Projekt.",
      askLabel: "Sitzungsbegleiter fragen",
      askPlaceholder: "Was sollte ich wissen?",
      askSubmit: "Fragen",
      askPending: "Sitzung wird geprüft…",
      askBusy: "Der Begleiter beantwortet bereits eine Frage.",
      askUnavailable: "Der Begleiter kann gerade nicht antworten.",
      asOf: "Stand {time}",
      health: {
        "on-track": "Auf Kurs",
        grinding: "Arbeitet",
        stuck: "Feststeckend",
        "waiting-on-user": "Wartet auf dich",
    ...
    observer: {
      title: "Session-Beobachter",
      plan: "Plan",
      progress: "{completed} von {total}",
      boardCurrentStatus: "Aktueller Status",
      boardTimeline: "Zustandsverlauf",
      boardCurrentRun: "Aktueller Durchlauf",
      boardPreviousRun: "Vorheriger Durchlauf",
      boardUnknownRun: "Nicht identifizierter Durchlauf",
      boardSinceYouLeft: "Seit deiner Abwesenheit",
      health: {
        "on-track": "Auf Kurs",
        grinding: "Arbeitet",
        stuck: "Feststeckend",
    ...
    composer: {
      ...
      cameraInput: "Kamera",
      cameraListUnsupported: "Dieser Browser kann keine Kameras auflisten.",
      cameraNoneFound: "Keine Kamera gefunden.",
      cameraPageInactive: "Kameras sind nicht verfügbar, während diese Seite inaktiv ist.",
      ...
      microphoneAppliesNextSession: "Änderungen werden bei deiner nächsten Talk-Sitzung wirksam.",
      microphoneListUnsupported: "Dieser Browser kann Mikrofoneingänge nicht auflisten.",
      noCameras: "Keine weiteren Kameras gefunden",
      ...
      holdToRecordSetting: "Mikrofontaste zum Diktieren gedrückt halten",
      holdToRecordSettingDescription:
        "Halte die Mikrofontaste im Editor gedrückt, sprich und lass dann los, um Text einzufügen, ohne zu senden.",
      dictationAudioUnsupported:
        "Das Gateway hat ein nicht unterstütztes Diktier-Audioformat zurückgegeben.",
      dictationBrowserAudioUnsupported:
        "Dieser Browser kann kein Diktier-Audio mit 8 kHz aufnehmen.",
      dictationConnecting: "Diktat wird gestartet…",
      dictationDisconnected: "Diktat wurde beendet, da das Gateway die Verbindung getrennt hat.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Diktat wurde beendet, bevor das letzte Teiltranskript finalisiert werden konnte.",
      dictationProviderUnavailable: "Für das Diktat ist kein Transkriptionsanbieter konfiguriert.",
      dictationRecording: "Aufnahme {elapsed}",
      dictationReleaseToInsert: "Loslassen, um Diktat einzufügen",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wähle eine andere Kamera oder den Systemstandard.",
      ...
      systemDefaultCamera: "Systemstandard",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Dieses Widget muss neu gerendert werden, um es als Bild zu exportieren.",
      widgetExportFailed: "Widget-Export fehlgeschlagen. Erneut versuchen.",
      pinToDashboard: "An Dashboard anheften",
      pinToDashboardPending: "Wird angeheftet…",
      pinnedToDashboard: "Angeheftet",
    ...
    backgroundTasks: {
      ...
      expandTask: "Details zu {title} anzeigen",
      detailTitle: "Aufgabendetails",
      backToTasks: "Zurück zu Hintergrundaufgaben",
      detailLoading: "Aufgabendetails werden geladen…",
      detailFailed: "Aufgabendetails konnten nicht geladen werden.",
      prompt: "Prompt",
      output: "Ausgabe",
      promptUnavailable: "Prompt nicht verfügbar.",
      outputPending: "Noch keine Ausgabe.",
    },
    sessionDiff: {
      title: "Änderungen",
    ...
    sessionDiscussion: {
      ...
      hide: "Diskussion ausblenden",
      disconnected: "Gateway ist getrennt.",
      loading: "Diskussion wird geladen…",
      opening: "Diskussion wird geöffnet…",
      requiresWriteAccess:
        "Für das Öffnen dieser Diskussion ist Schreibzugriff als Operator erforderlich.",
      openExternal: "Diskussion in neuem Tab öffnen",
      frameTitle: "Sitzungsdiskussion",
      unavailable: "Diese Diskussion kann nicht eingebettet werden.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Läuft jede Sekunde",
      ...
      summaryEverySeconds: "Läuft alle {amount} Sekunden",
      ...
      script: "Skript",
      readOnlyPayloadHelp:
        "Diese Payload wurde außerhalb der Control UI erstellt. Ihr Inhalt bleibt schreibgeschützt und wird beim Speichern anderer Änderungen beibehalten.",
