...
export const pt_BR: TranslationMap = {
  common: {
    ...
    staleData: "Exibindo dados desatualizados.",
    reload: "Recarregar",
    reset: "Redefinir",
    restore: "Restaurar",
  ...
  channels: {
    ...
    hub: {
      connectedTitle: "Seus canais",
      addTitle: "Adicionar um canal",
      addSubtitle: "Escolha um serviço e siga a configuração guiada.",
      updatedAgo: "Atualizado {ago}",
      noneConnected: "Nenhum canal conectado ainda. Escolha um abaixo para começar.",
      partialSnapshot:
        "Algumas verificações de canais não foram concluídas dentro do tempo limite da interface.",
      stateRunning: "Em execução",
      stateConfigured: "Configurado",
      stateAttention: "Requer atenção",
      setUp: "Configurar",
      guidedSetup: "Configuração guiada passo a passo",
      openDetails: "Abrir detalhes",
      lastMessageAgo: "Última mensagem {ago}",
      browseAllTitle: "Mais canais…",
      browseAllSubtitle: "Explore todos os canais disponíveis, incluindo plugins instaláveis.",
      runSetup: "Executar configuração",
      saveBeforeSetup:
        "Há alterações não salvas na configuração do canal. Salve-as ou recarregue-as antes de executar a configuração guiada.",
    },
    pairing: {
      title: "Solicitações de acesso a DM",
      subtitle:
        "Analise as pessoas que aguardam para enviar mensagens diretas a canais protegidos por pareamento.",
      channelFilter: "Canal",
      accountFilter: "Conta",
      ...
      approve: "Aprovar",
      dismiss: "Dispensar",
      approveAria: "Aprovar {sender} para {channel}, conta {account}",
      dismissAria: "Dispensar {sender} para {channel}, conta {account}",
      requested: "Solicitado {ago}",
      expires: "Expira {ago}",
      senderDetails: "Detalhes do remetente",
      missingPermission:
        "Esta conexão não tem acesso operator.pairing, portanto as solicitações de DM não podem ser analisadas.",
      noAccounts: "Nenhuma conta de canal configurada usa o pareamento de remetentes de DM.",
      noRequests: "Nenhuma solicitação de acesso a DM pendente.",
      noFilteredRequests: "Nenhuma solicitação pendente corresponde a esses filtros.",
      limits:
        "As solicitações expiram após {minutes} minutos. Cada conta de canal pode manter até {count} solicitações pendentes.",
      detailTitle: "Acesso a DM",
      detailSubtitle:
        "As pessoas devem ser aprovadas antes que suas mensagens diretas cheguem ao agente.",
      pendingCount: "{count} pendente(s)",
      noPending: "Nenhuma solicitação pendente",
      review: "Revisar solicitações",
      approveDialogTitle: "Aprovar acesso a DM",
      dismissDialogTitle: "Descartar solicitação de acesso a DM",
      approveExplanation:
        "Isso permite que o remetente converse com o agente em mensagens diretas. Não concede acesso a grupos.",
      dismissExplanation:
        "Isso remove a solicitação atual, mas não bloqueia o remetente. Ele pode solicitar acesso novamente mais tarde.",
      notifyRequester: "Notificar o solicitante após a aprovação",
      makeCommandOwner: "Também tornar este remetente o primeiro proprietário de comandos",
      commandOwnerHelp:
        "Proprietários de comandos podem executar comandos privilegiados e aprovar ações perigosas. Esta opção só está disponível enquanto nenhum proprietário estiver configurado.",
      commandOwnerNeedsAdmin:
        "Nenhum proprietário de comandos está configurado. Esta conexão precisa de operator.admin para atribuir o primeiro proprietário.",
      approvedNotice: "Acesso a DM aprovado.",
      approvedOwnerNotice:
        "Acesso a DM aprovado e o primeiro proprietário de comandos foi configurado.",
      approvedNotificationFailedNotice:
        "Acesso a DM aprovado, mas a notificação do solicitante não pôde ser entregue.",
      approvedOwnerFailedNotice:
        "Acesso a DM aprovado, mas o primeiro proprietário de comandos não pôde ser configurado.",
      approvedFollowupsFailedNotice:
        "Acesso a DM aprovado, mas a notificação do solicitante e a configuração do proprietário de comandos falharam.",
      dismissedNotice:
        "Solicitação de acesso a DM descartada. O remetente pode solicitar acesso novamente.",
    },
    setup: {
      dialogLabel: "Configurar {channel}",
      title: "Configurar {channel}",
      genericTitle: "um canal",
      subtitle: "Uma breve configuração guiada — você poderá ajustar tudo depois.",
      starting: "Iniciando a configuração…",
      working: "Trabalhando…",
      sessionExpired:
        "Esta sessão de configuração expirou após a reinicialização do Gateway. Feche este diálogo e inicie a configuração do canal novamente.",
      continue: "Continuar",
      finish: "Concluir",
      copyText: "Copiar",
      openLink: "Abrir link",
      ...
      whatsappQrLoading: "Gerando código QR…",
      whatsappQrHint: "Clique em Mostrar QR para gerar um código de pareamento.",
      whatsappLinked: "O WhatsApp está vinculado e pronto.",
      regenerateQr: "Novo código QR",
      linkLater: "Vincular mais tarde",
    },
    config: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão armazenada do WhatsApp foi limpa. Ela pode já estar ausente ou seu diretório de autenticação pode exigir limpeza manual.",
    },
  ...
  agentChip: {
    ...
    agents: "Agentes",
    openChat: "Conversar com {name}",
    offlineOpenSettings: "Offline — abrir Configurações",
  ...
  newSession: {
    ...
    worktree: "Worktree",
    checkingGit: "Verificando disponibilidade do Git…",
    gitCheckUnavailable:
      "Não foi possível verificar o Git para esta pasta. Selecione-a novamente para tentar de novo.",
    ...
    incognito: "Anônimo",
    incognitoDescription: "Manter este tópico apenas até o Gateway reiniciar",
    ...
    createOutcomeUnknown:
      "O Gateway foi alterado enquanto esta sessão estava sendo iniciada. Verifique as sessões recentes antes de iniciar esta tarefa novamente.",
  ...
  sessionsView: {
    ...
    sessionState: "Estado do thread",
    all: "Todos",
    sessionArchived: "Thread arquivado",
    sessionsArchived: "{count} threads arquivados",
    deleteAllArchived: "Excluir todos os arquivados…",
    deleteAllArchivedConfirm: "Excluir {count} threads arquivados e suas transcrições?",
    ...
    runFailedReason: "Execução falhou: {reason}",
    ...
    lastActive: "Ativo pela última vez {time}",
    surface: "Superfície",
    subject: "Assunto",
    room: "Sala",
    space: "Espaço",
    ...
    showChildSessions: "Mostrar {count} sessões filhas de {session}",
    hideChildSessions: "Ocultar {count} sessões filhas de {session}",
    childSessions: "Sessões filhas",
    showMoreChildren: "Mostrar mais {count}",
    archived: "Arquivada",
    pinned: "Fixadas",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Worker filho na nuvem: 1 conflito de workspace",
    cloudWorkerDescendantConflicts: "Workers filhos na nuvem: {count} conflitos de workspace",
    ...
    invalidEmojiIcon: "Insira exatamente um emoji.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Seu perfil do gateway",
      ...
      profileHint:
        "JPEG, PNG ou WebP. As imagens são cortadas ao centro e redimensionadas para 512px.",
      profileLoadFailed: "Não foi possível carregar seu perfil.",
      profileSaveFailed: "Não foi possível salvar seu perfil.",
      avatarInvalid: "Escolha uma imagem JPEG, PNG ou WebP válida.",
      avatarTooLarge: "O avatar processado ainda está muito grande.",
  ...
  configView: {
    ...
    syncedHint: "Sincronizado entre seus dispositivos por meio do gateway.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Barra lateral",
      hint: "Escolha o que aparece enquanto as sessões estão em execução.",
      liveActivity: "Mostrar atividade do agente ao vivo na barra lateral",
      liveActivityHint:
        "Mostrar a atividade mais recente do assistente ou da ferramenta abaixo das sessões em execução.",
    },
    sessionObserver: {
      title: "Observador de sessão",
      hint: "Resuma sessões de longa duração com um pequeno modelo utilitário.",
      toggle: "Observador de sessão",
      toggleHint: "Gerar resumos de status ao vivo para sessões inscritas na Control UI.",
      resolvedModel: "Modelo pequeno resolvido",
      ...
      disabled: "Desativada",
      toggleNote: "Atualizar o observador de sessão da Control UI",
    ...
    rawDraftBlocksApply:
      "Edições não salvas na configuração raw — salve ou descarte-as no editor Raw antes de reiniciar.",
    rawDraftPendingFormTitle:
      "Edições não salvas na configuração raw — salve ou descarte-as antes de mudar para Formulário.",
    rawDraftBlocksFormEdit:
      "Edições não salvas na configuração raw não puderam ser interpretadas; resolva-as no editor Raw antes de alterar as configurações.",
    invalidConfig:
  ...
  execApproval: {
    ...
    otherPending: "Outras solicitações pendentes",
    reviewRequest: "Revisar aprovação de {agent}: {command}",
    agentPendingOne: "{count} aprovação pendente",
    agentPending: "{count} aprovações pendentes",
  ...
  terminal: {
    ...
    noSessions: "Nenhuma sessão de terminal ativa",
  ...
  tabs: {
    ...
    modelSetup: "Configuração do modelo",
  ...
  subtitles: {
    ...
    apps: "Aplicativos complementares para telefone, relógio, desktop e navegador.",
    ...
    labs: "Recursos experimentais de agentes e ferramentas.",
    ...
    modelSetup: "Conecte um modelo de IA verificado",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport:
      "Traga a memória do Codex e do Claude Code para o espaço de trabalho de um agente.",
    notifications: "Notificações push do navegador a partir do seu gateway.",
    security: "Autenticação do Gateway, política de exec, perfil de ferramentas e aprovações.",
    advanced: "Todas as seções de configuração restantes, além do editor de arquivo bruto.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      signInNeeded: "Login necessário",
      detected: "Detectado",
      testAndUse: "Testar e usar",
    ...
    signIn: {
      title: "Faça login com um provedor",
      signIn: "Fazer login",
      pair: "Emparelhar",
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Baixe um modelo compatível com ferramentas do seu servidor Ollama",
    ...
    manual: {
      ...
      accessValue: "Chave de API ou token",
      accessValuePlaceholder: "Cole uma chave de API ou token",
      connect: "Conectar",
      required: "Escolha um provedor e insira uma chave de API ou token.",
    },
    success: {
    ...
    failure: {
      ...
      rateLimit: "Limite de requisições atingido",
      billing: "Problema de cobrança",
      timeout: "Tempo limite excedido",
      format: "Resposta inválida",
      unavailable: "Indisponível",
      unknown: "Falha na conexão",
    },
    errors: {
      requestFailed: "Falha na solicitação de configuração do modelo.",
      activationFailed: "Não foi possível ativar o modelo.",
    },
    wizard: {
      ...
      continue: "Continuar",
      submit: "Enviar",
      openSignIn: "Abrir página de login",
      copy: "Copiar",
      expires: "Expira em {count} minutos",
      cancelled: "O login no provedor foi cancelado.",
      sessionExpired:
        "Esta sessão de configuração expirou após a reinicialização do Gateway. Feche esta caixa de diálogo e inicie a configuração do modelo novamente.",
      notComplete: "O login foi concluído, mas a configuração do modelo ainda não está completa.",
    },
  },
  memoryImport: {
    unknownCollection: "Coleção de memórias",
    claudeCode: "Claude Code",
    fileCountOne: "{count} arquivo",
    fileCount: "{count} arquivos",
    alreadyImported: "{count} existentes",
    ready: "Pronto",
    existing: "Existentes",
    importComplete: "Importação concluída",
    importIncomplete: "Importação incompleta",
    importedCount: "{count} arquivos importados",
    importedWithIssues: "{migrated} importados · {errors} com falha · {conflicts} conflitos",
    reportSaved: "relatório salvo",
    recoveryFile: "Arquivo de recuperação",
    recoveryJournal: "Diário de recuperação",
    itemBackup: "Backup do item",
    codexDescription: "Arquivos de memória consolidados do Codex.",
    claudeDescription: "Arquivos de memória automática por projeto do Claude Code.",
    providerFallback: "Importe a memória do assistente para o espaço de trabalho deste agente.",
    reviewFiles: "Revisar arquivos",
    notFound: "Não encontrado",
    noMemoryFound: "Nenhuma memória importável foi encontrada neste computador.",
    source: "Origem",
    destination: "Destino",
    selectedCount: "{count} selecionados",
    selectAtLeastOne: "Selecione pelo menos um arquivo",
    importSelected: "Importar selecionados",
    confirmTitle: "Importar de {provider}?",
    confirmDescription:
      "Copie {count} arquivos de memória selecionados para o espaço de trabalho deste agente.",
    confirmReplace:
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Esta edição manual não passou na validação de configuração.",
      opaqueChange:
        "Formatação ou comentários alterados sem mudanças visíveis no caminho de configuração.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "configurações",
        cli: "CLI",
        pluginInstall: "instalação de plugin",
        manualEdit: "edição manual",
        unknown: "desconhecido",
      },
    },
    nudge: {
      configReload: "A recarga da configuração foi interrompida — pergunte-me o que aconteceu",
      channelAuth: "A autenticação do {channel} foi degradada — pergunte-me o que aconteceu",
      channelDisconnected: "O {channel} acabou de desconectar — pergunte-me o que aconteceu",
      channelDegraded: "O {channel} está degradado — pergunte-me o que aconteceu",
      channelFallback: "Um canal",
      dismiss: "Dispensar esta atualização",
    },
  },
  mcpServers: {
    ...
    addedSuccess: "Servidor MCP {name} adicionado.",
    enabledSuccess: "Servidor MCP {name} ativado.",
    disabledSuccess: "Servidor MCP {name} desativado.",
    removedSuccess: "Servidor MCP {name} removido.",
    configUnavailable: "A configuração está indisponível; atualize e tente novamente.",
    connectRequired: "Conecte-se ao gateway para alterar servidores MCP.",
    adminRequired: "Alterações em servidores MCP exigem acesso operator.admin.",
    enable: "Ativar",
    disable: "Desativar",
  ...
  mcpPage: {
    connectorsLink: "Descubra conectores de um clique na página de Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  sessionsPage: {
    hubTablistLabel: "Seções de threads",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "O Labs contém recursos experimentais que podem mudar, quebrar ou desaparecer entre versões.",
    sectionTitle: "Recursos experimentais",
    sectionDescription:
      "As alterações são salvas imediatamente e se aplicam a execuções futuras do agente.",
    documentation: "Documentação",
    restartRequired: "É necessário reiniciar o Gateway.",
    saveErrorTitle: "Não foi possível atualizar o recurso",
    saveFailed: "A configuração do recurso não pôde ser salva.",
    codeMode: {
      title: "Code Mode",
      description:
        "Permita que agentes combinem ferramentas em fluxos de trabalho JavaScript compactos e isolados.",
    },
    swarm: {
      title: "Swarm",
      description: "Permita que o Code Mode orquestre grupos de subagentes em paralelo.",
      empty: "Nenhum swarm ativo.",
  ...
  appsPage: {
    ...
    havePhone: "Já tem o aplicativo?",
    pairDevice: "Emparelhe seu dispositivo",
    sectionWatch: "No seu pulso",
    sectionDesktop: "No seu desktop",
    sectionBrowser: "No seu navegador",
    sectionCommunity: "Comunidade",
    badgeBundledIos: "Incluído no aplicativo iOS",
    badgeBundledAndroid: "Incluído no aplicativo Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Baixar",
    ctaDocs: "Documentação",
    ctaSetupGuide: "Guia de configuração",
    ctaOpenPlugins: "Abrir Plugins",
    ctaBrowseClawHub: "Explorar ClawHub",
    linkDiscord: "Comunidade do Discord",
    linkDocs: "Documentação",
    cards: {
      ios: {
        title: "iPhone",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Conversas rápidas e respostas ágeis direto do seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Complemento na barra de menus para o seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Aplicativo nativo para desktop — versões .deb e AppImage.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Mostrar quem está online",
    rosterTitle: "Online",
    serverRegion: "Servidor",
    you: "você",
  },
  profilePage: {
    ...
    identity: {
      ...
      menuButtonLabel: "Menu de identidade e do app para {name}",
      ...
      notSet: "A identidade não está definida.",
      setIdentity: "Definir identidade",
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG ou WebP. As imagens são redimensionadas para 256 × 256 ou menor.",
      chooseAvatar: "Escolher imagem",
      processingAvatar: "Processando…",
      displayName: "Nome de exibição",
      displayNameDescription: "Exibido para outras pessoas que usam este gateway.",
      linkedEmails: "E-mails vinculados",
      linkedEmailsDescription: "Endereços de e-mail conectados a este perfil.",
      openSettings: "Abrir configurações de identidade de {name}",
      avatarErrors: {
        invalid: "Não foi possível processar essa imagem.",
        sourceTooLarge: "Escolha uma imagem de 10 MB ou menor.",
        tooLarge: "O avatar processado é maior que 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    ...
    file: "Arquivo: {file}",
    truncated: "Saída de log truncada; exibindo o trecho mais recente.",
    empty: "Nenhuma entrada de log.",
  },
  pluginTabs: {
  ...
  board: {
    label: "Painel de threads",
    tabsLabel: "Abas do painel",
    moreTabs: "Mais abas do painel",
    gridLabel: "Widgets do painel",
    emptyTitle: "Um painel limpo, pronto para o trabalho",
    emptyHint: "Seu agente pode fixar widgets aqui — tente pedir um cartão de status.",
    actionFailed: "Não foi possível salvar a alteração do painel.",
    actionInProgress: "Outra alteração do painel ainda está sendo salva.",
    announcement: {
      moved: "{title} movido.",
      resized: "{title} redimensionado.",
      removed: "{title} removido.",
      granted: "Acesso ao widget permitido.",
      rejected: "Acesso ao widget rejeitado.",
    },
    widget: {
      cellLabel:
        "Widget do painel: {title}. Use as teclas de seta para navegar. Segure Alt e pressione uma tecla de seta para movê-lo.",
      moveHandle: "Mover {title}",
      resizeHandle: "Redimensionar {title}",
      menuLabel: "Opções do widget",
      moveToTab: "Mover para a aba",
      noOtherTabs: "Nenhuma outra aba",
      ...
      rejectedDetail: "Este widget permanece inativo até ser removido ou substituído.",
      appLoading: "Restaurando app…",
      appStaleTitle: "Este app fixado está desatualizado",
      appStaleDetail: "Seu servidor, recurso ou transcrição de origem não está mais disponível.",
      retry: "Tentar novamente",
      ...
      frameAuthorizationFailed:
        "A autorização do widget falhou após repetidas tentativas de atualização.",
      sandboxOriginRequired:
        "A autorização do widget falhou após repetidas tentativas de atualização. Se o gateway funciona por trás de um proxy reverso ou túnel que não roteia a porta do sandbox do widget, defina mcp.apps.sandboxOrigin para uma origem pública dedicada roteada para o listener do sandbox.",
      errorTitle: "Não foi possível carregar este widget",
      errorDetail: "O problema está contido neste cartão.",
      actionErrorTitle: "Falha na alteração do widget",
      actionErrorDetail: "O painel manteve o estado anterior do widget.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Ainda não há painel — o agente em execução pode fixar widgets.",
    openSession: "Abrir sessão",
  ...
  attention: {
    ...
    pendingApproval: "{count} aprovação pendente",
  ...
  modelProviders: {
    ...
    globalUsage: "Uso e custo globais",
    ...
    configUnavailable: "A configuração está indisponível. Atualize e tente novamente.",
    credentials: {
      label: "Credenciais para {agent}",
      oauth: "Perfis OAuth: {count}",
      tokenProfiles: "Perfis de token: {count}",
      configKey: "Chave de API definida na configuração",
      envKey: "Chave de API do ambiente",
      envKeyNamed: "Chave de API do ambiente ({name})",
      profileKey: "Perfis de chave de API: {count}",
      none: "Não configurado",
    },
    apiKey: {
      label: "Chave de API",
      placeholder: "Insira a chave de API do provedor",
      replacePlaceholder: "Segredo salvo. Insira uma nova chave para substituí-la.",
      set: "Definir chave de API",
      replace: "Substituir chave",
      remove: "Remover chave",
      saved: "Segredo salvo.",
      removed: "Chave de API removida.",
      authModeBlocked:
        'As alterações da chave de API não estão disponíveis enquanto o modo de autenticação for "{mode}".',
    },
    probe: {
      test: "Testar conexão",
      testing: "Testando…",
      unavailable: "O teste de conexão requer um Gateway mais recente.",
      latency: "{ms} ms",
      status: {
        ok: "Conectado",
        auth: "Falha na autenticação",
        ...
        format: "Resposta inválida",
        unknown: "Falha na conexão",
        no_model: "Nenhum modelo disponível",
      },
    },
    logout: {
      action: "Sair",
      confirm: "Sair de {provider}? Os perfis de OAuth e token salvos serão removidos.",
      loggingOut: "Saindo…",
      done: "Sessão encerrada.",
    },
    add: {
      title: "Adicionar provedor",
      subtitle: "Escolha um provedor de modelos conhecido e salve a chave de API dele.",
      action: "Adicionar provedor",
      none: "Todos os provedores conhecidos já estão configurados.",
      provider: "Provedor",
      selectProvider: "Selecione um provedor",
      save: "Salvar provedor",
      saved: "Provedor {provider} adicionado.",
    },
    defaults: {
      title: "Modelos padrão",
      subtitle:
        "Escolha o modelo principal, os modelos alternativos em ordem e o modelo utilitário.",
      primary: "Modelo padrão",
      utility: "Modelo utilitário",
      automatic: "Automático (padrão do provedor)",
      disabled: "Desativada",
      savedSelection: "Seleção salva",
      fallbacks: "Fallbacks",
      noFallbacks: "Nenhum modelo alternativo configurado.",
      unsaved: "Alterações não salvas",
      addFallback: "Adicionar modelo alternativo",
      selectModel: "Selecione um modelo",
      selectFallback: "Selecione um modelo alternativo",
      noModels: "Configure um provedor antes de selecionar os modelos padrão.",
      saved: "Modelos padrão salvos.",
    },
    readOnly: {
      disconnected: "Conecte-se ao Gateway para alterar as configurações dos modelos.",
      adminRequired: "Somente navegação. Alterações de modelo exigem acesso operator.admin.",
    },
    notes: {
      saveKey: "Salvar a chave de API de {provider} pelo Control UI",
      removeKey: "Remover a chave de API de {provider} pelo Control UI",
      addProvider: "Adicionar o provedor de modelos {provider} pelo Control UI",
      defaultModel: "Atualizar a seleção do modelo padrão pelo Control UI",
    },
  },
  usage: {
    common: {
    ...
    details: {
      ...
      loadFailed: "Não foi possível carregar {detail}: {error}",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable:
        "A solicitação de emparelhamento do navegador ainda não está disponível. Tente novamente em um instante.",
      loadFailed:
        "Não foi possível carregar a solicitação de emparelhamento deste navegador: {error}",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "O thread mudou de ramificação — revise e reenvie.",
    },
    waitingForApproval: "Aguardando aprovação…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Somente o proprietário e os membros do tópico podem agir neste tópico.",
    },
    sessionSuggestions: {
      suggest: "Sugerir",
    ...
    sessionHeader: {
      ...
      renameAria: "Renomear sessão {title}",
      renameInputAria: "Título da sessão",
      renameInputPlaceholder: "Título da sessão",
      workspaceAria: "Ações do workspace para {workspace}",
      revealFinder: "Mostrar no Finder",
      revealFileExplorer: "Mostrar no Explorador de Arquivos",
      revealFileManager: "Abrir no gerenciador de arquivos",
      ...
      branchSwitchRequiresAdmin:
        "A troca de ramificação requer acesso de administrador do operador.",
      untitledBranch: "Ramificação sem título",
      oneMessage: "{count} mensagem",
      messages: "{count} mensagens",
      activeBranch: "Ramificação ativa",
    },
    board: {
      faceLabel: "Face do thread",
      chatFace: "Chat",
      dashboardFace: "Painel",
      dockMenu: "Encaixe do chat: {dock}",
      dockLeft: "Encaixar chat à esquerda",
      dockRight: "Encaixar chat à direita",
      dockBottom: "Encaixar chat embaixo",
      dockHidden: "Ocultar chat",
      resizeDock: "Redimensionar encaixe do chat",
      reopenChat: "Mostrar chat",
      workboardCard: "Cartão do quadro de trabalho: {title}, {status}",
      defaultTab: "Principal",
      mockPlaceholder: "Junção da visualização do quadro · {tabs} abas · {widgets} widgets",
      mockOverview: "Visão geral",
      mockResearch: "Pesquisa",
      mockSessionStatus: "Status do tópico",
      mockRecentFindings: "Descobertas recentes",
      mockSourceMap: "Mapa de fontes",
      resetTitle: "Redefinir conversa?",
      resetDescription: "O contexto da conversa é redefinido. Seu painel permanece.",
    },
    catalog: {
    ...
    followUpModeServer: "Padrão do servidor ({mode})",
    followUpModeLoading: "carregando…",
    followUpModeSteer: "Direcionar para a execução ativa",
    followUpModeUsingServer: "Usando padrão do servidor ({mode})",
    ...
    workspaceConflict: {
      ...
      inspectCloud: "Inspecionar a primeira versão da nuvem",
      takeCloud: "Usar a primeira versão da nuvem",
      copyInspectCommand: "Copiar comando de inspeção da nuvem",
      copyTakeCommand: "Copiar comando take-cloud",
      commandHelp:
      ...
      eventTitleMany: "Resultado da nuvem aplicado com {count} conflitos",
      eventDescription:
        "As versões locais foram mantidas para esses caminhos; outras alterações da nuvem foram aplicadas.",
    },
    compaction: {
    ...
    progressLabels: {
      shelling: "Criando conchas",
      scuttling: "Andando de lado",
      clawing: "Agarrando",
      pinching: "Beliscando",
      molting: "Trocando de carapaça",
      bubbling: "Borbulhando",
      tiding: "Seguindo a maré",
      reefing: "Explorando recifes",
      cracking: "Quebrando",
      sifting: "Peneirando",
      brining: "Mergulhando em salmoura",
      nautiling: "Nautilando",
      krilling: "Krillando",
      barnacling: "Criando cracas",
      lobstering: "Lagosteando",
      tidepooling: "Explorando poças de maré",
      pearling: "Produzindo pérolas",
      snapping: "Estalando",
      surfacing: "Emergindo",
    },
    turnRecap: {
    ...
    sidebar: {
      ...
      updateMacAndGateway: "Atualizar o app para Mac + Gateway",
      updateGateway: "Atualizar o Gateway",
      allSessions: "Todas as sessões",
      threads: "Threads",
      groups: "Grupos",
      coding: "Programação",
      groupCatalogSessionsByProject: "Agrupar por projeto",
    ...
    questions: {
      ...
      skipping: "Ignorando…",
      skipped: "Ignoradas",
      collapse: "Recolher pergunta",
      expand: "Expandir pergunta",
      eyebrow: "Pergunta",
      cardLabel: "Pergunta do assistente",
      summaryLabel: "Resultado da pergunta",
      timeRemaining: "Tempo restante",
      ownAnswer: "Sua própria resposta…",
      ownAnswerFor: "Sua própria resposta para {header}",
      submitting: "Enviando…",
      submitFailed: "Não foi possível enviar: {error}",
      answered: "Respondido",
      answeredElsewhere: "Respondida em outro lugar",
      unavailable: "Indisponível",
      expired: "Expirado",
      cancelled: "Cancelado",
    },
    imageLightbox: {
      label: "Pré-visualização da imagem: {title}",
      open: "Abrir imagem {title}",
      openOriginal: "Abrir original",
      close: "Fechar pré-visualização da imagem",
      untitled: "Imagem",
    },
    messages: {
      activity: "Atividade",
      ...
      hide: "Ocultar",
      hideConfirm: "Ocultar esta mensagem neste navegador? O agente ainda a vê.",
      hideMessage: "Ocultar mensagem",
      hideTooltip: "Ocultar somente neste navegador",
      ...
      rewindUnavailable: "Retroceder não está disponível enquanto o agente está trabalhando",
      forkUnavailable: "Bifurcar não está disponível enquanto o agente está trabalhando",
    ...
    modelControls: {
      ...
      reasoning: "Raciocínio",
      speed: "Velocidade",
      sessionOverride: "Substituição do thread",
      usingDefault: "Usando o padrão das Configurações",
      resetToDefault: "Redefinir para o padrão ({model})",
    },
    rail: {
      title: "Assistente da sessão",
      subtitle: "Pergunte sobre esta sessão ou seu projeto",
      expand: "Expandir barra da sessão",
      collapse: "Recolher barra da sessão",
      hide: "Ocultar barra da sessão",
      show: "Mostrar barra da sessão",
      clear: "Limpar conversa do assistente",
      plan: "Plano",
      progress: "{completed} de {total}",
      pullRequests: "Pull requests",
      checksPassing: "{count} aprovadas",
      checksFailing: "{count} falharam",
      checksPending: "{count} em execução",
      finished: "Concluído {time}",
      empty: "Faça uma pergunta somente leitura sobre esta sessão ou seu projeto.",
      askLabel: "Pergunte ao assistente da sessão",
      askPlaceholder: "O que devo saber?",
      askSubmit: "Perguntar",
      askPending: "Verificando a sessão…",
      askBusy: "O assistente já está respondendo a uma pergunta.",
      askUnavailable: "O assistente não pode responder agora.",
      asOf: "em {time}",
      health: {
    ...
    observer: {
      ...
      plan: "Plano",
      progress: "{completed} de {total}",
      boardCurrentStatus: "Status atual",
      boardTimeline: "Linha do tempo de integridade",
      boardCurrentRun: "Execução atual",
      boardPreviousRun: "Execução anterior",
      boardUnknownRun: "Execução não identificada",
      boardSinceYouLeft: "Desde que você saiu",
      health: {
        "on-track": "No caminho certo",
        grinding: "Trabalhando",
        stuck: "Travado",
    ...
    composer: {
      ...
      cameraBusy: "A câmera está ocupada ou indisponível para o navegador.",
      cameraFallback: "Câmera {number}",
      cameraInput: "Câmera",
      cameraListUnsupported: "Este navegador não consegue listar câmeras.",
      cameraNoneFound: "Nenhuma câmera foi encontrada.",
      cameraPageInactive: "As câmeras ficam indisponíveis enquanto esta página estiver inativa.",
      cameraPermissionBlocked:
        "O acesso à câmera está bloqueado. Permita o acesso à câmera e ao microfone nas configurações do site no navegador.",
      ...
      microphoneAppliesNextSession:
        "As alterações se aplicam quando você iniciar sua próxima sessão do Talk.",
      microphoneListUnsupported: "Este navegador não consegue listar as entradas de microfone.",
      noCameras: "Nenhuma câmera adicional encontrada",
      ...
      holdToRecordSetting: "Mantenha o botão do microfone pressionado para ditar",
      holdToRecordSettingDescription:
        "Mantenha pressionado o botão do microfone do compositor, fale e solte para inserir o texto sem enviar.",
      dictationAudioUnsupported: "O Gateway retornou um formato de áudio de ditado não suportado.",
      dictationBrowserAudioUnsupported:
        "Este navegador não consegue capturar áudio de ditado a 8 kHz.",
      dictationConnecting: "Iniciando ditado…",
      dictationDisconnected: "O ditado foi interrompido porque o Gateway se desconectou.",
      dictationFailed: "Falha no ditado.",
      dictationFinalizing: "Finalizando ditado…",
      dictationFinalizationTimedOut:
        "O ditado foi interrompido antes que a última transcrição parcial pudesse ser finalizada.",
      dictationProviderUnavailable:
        "Nenhum provedor de transcrição está configurado para o ditado.",
      dictationRecording: "Gravando {elapsed}",
      dictationReleaseToInsert: "Solte para inserir o ditado",
      ...
      selectedCameraUnavailable:
        "A câmera selecionada está indisponível. Escolha outra câmera ou o padrão do sistema.",
      ...
      turnCameraOff: "Desligar câmera",
      turnCameraOn: "Ligar câmera",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Este widget precisa ser renderizado novamente para ser exportado como imagem.",
      widgetExportFailed: "Falha ao exportar o widget. Tente novamente.",
      pinToDashboard: "Fixar no painel",
      pinToDashboardPending: "Fixando…",
      pinnedToDashboard: "Fixadas",
    ...
    backgroundTasks: {
      ...
      prompt: "Prompt",
      output: "Saída",
      promptUnavailable: "Prompt indisponível.",
      outputPending: "Ainda não há saída.",
    },
    sessionDiff: {
      title: "Alterações",
    ...
    sessionDiscussion: {
      ...
      hide: "Ocultar discussão",
      disconnected: "Gateway está desconectado.",
      loading: "Carregando discussão…",
      opening: "Abrindo discussão…",
      requiresWriteAccess: "É necessário acesso de escrita de operador para abrir esta discussão.",
      openExternal: "Abrir discussão em uma nova aba",
      frameTitle: "Discussão da sessão",
      unavailable: "Esta discussão não pode ser incorporada.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Executa a cada segundo",
      ...
      summaryEverySeconds: "Executa a cada {amount} segundos",
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Este payload foi criado fora do Control UI. Seu conteúdo permanece somente leitura e é preservado quando você salva outras alterações.",
