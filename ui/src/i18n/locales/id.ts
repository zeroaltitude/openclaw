...
export const id: TranslationMap = {
  common: {
    ...
    refresh: "Muat ulang",
    retry: "Coba lagi",
    staleData: "Data lama sedang ditampilkan.",
    reload: "Muat ulang",
    reset: "Atur Ulang",
    restore: "Pulihkan",
  ...
  channels: {
    ...
    pairing: {
      title: "Permintaan akses DM",
      subtitle:
        "Tinjau orang yang menunggu untuk mengirim pesan langsung ke channel yang dilindungi pairing.",
      channelFilter: "Saluran",
      accountFilter: "Akun",
      allChannels: "Semua channel",
      allAccounts: "Semua akun",
      approve: "Setujui",
      dismiss: "Abaikan",
      approveAria: "Setujui {sender} untuk {channel}, akun {account}",
      dismissAria: "Abaikan {sender} untuk {channel}, akun {account}",
      requested: "Diminta {ago}",
      expires: "Kedaluwarsa {ago}",
      senderDetails: "Detail pengirim",
      missingPermission:
        "Koneksi ini tidak memiliki akses operator.pairing, sehingga permintaan DM tidak dapat ditinjau.",
      noAccounts: "Tidak ada akun channel yang dikonfigurasi yang menggunakan pairing pengirim DM.",
      noRequests: "Tidak ada permintaan akses DM yang tertunda.",
      noFilteredRequests: "Tidak ada permintaan tertunda yang cocok dengan filter ini.",
      limits:
        "Permintaan kedaluwarsa setelah {minutes} menit. Setiap akun channel dapat menyimpan hingga {count} permintaan tertunda.",
      detailTitle: "Akses DM",
      detailSubtitle: "Seseorang harus disetujui sebelum pesan langsung mereka sampai ke agen.",
      pendingCount: "{count} menunggu",
      noPending: "Tidak ada permintaan yang menunggu",
      review: "Tinjau permintaan",
      approveDialogTitle: "Setujui akses DM",
      dismissDialogTitle: "Abaikan permintaan akses DM",
      approveExplanation:
        "Ini memungkinkan pengirim berbicara dengan agen dalam pesan langsung. Ini tidak memberikan akses grup.",
      dismissExplanation:
        "Ini menghapus permintaan saat ini tetapi tidak memblokir pengirim. Mereka dapat meminta akses lagi nanti.",
      notifyRequester: "Beri tahu pemohon setelah disetujui",
      makeCommandOwner: "Jadikan juga pengirim ini sebagai pemilik perintah pertama",
      commandOwnerHelp:
        "Pemilik perintah dapat menjalankan perintah istimewa dan menyetujui tindakan berbahaya. Opsi ini hanya tersedia saat tidak ada pemilik yang dikonfigurasi.",
      commandOwnerNeedsAdmin:
        "Tidak ada pemilik perintah yang dikonfigurasi. Koneksi ini memerlukan operator.admin untuk menetapkan pemilik pertama.",
      approvedNotice: "Akses DM disetujui.",
      approvedOwnerNotice: "Akses DM disetujui dan pemilik perintah pertama telah dikonfigurasi.",
      approvedNotificationFailedNotice:
        "Akses DM disetujui, tetapi notifikasi pemohon tidak dapat dikirim.",
      approvedOwnerFailedNotice:
        "Akses DM disetujui, tetapi pemilik perintah pertama tidak dapat dikonfigurasi.",
      approvedFollowupsFailedNotice:
        "Akses DM disetujui, tetapi notifikasi pemohon dan pengaturan pemilik perintah keduanya gagal.",
      dismissedNotice: "Permintaan akses DM diabaikan. Pengirim dapat meminta akses lagi.",
    },
    setup: {
      ...
      working: "Sedang bekerja…",
      sessionExpired:
        "Sesi penyiapan ini kedaluwarsa setelah Gateway dimulai ulang. Tutup dialog ini, lalu mulai penyiapan saluran lagi.",
      continue: "Lanjutkan",
      finish: "Selesai",
      copyText: "Salin",
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Mungkin sudah tidak ada, atau direktori autentikasinya memerlukan pembersihan manual.",
    },
  ...
  agentChip: {
    menuLabel: "Menu agen",
    agents: "Agen",
    openChat: "Ngobrol dengan {name}",
    offlineOpenSettings: "Offline — buka Pengaturan",
  ...
  newSession: {
    ...
    places: "Tempat",
    recentFolders: "Terbaru",
    runsOn: "Berjalan di {place}",
    ...
    worktree: "Worktree",
    checkingGit: "Memeriksa ketersediaan Git…",
    gitCheckUnavailable:
      "Tidak dapat memverifikasi Git untuk folder ini. Pilih lagi untuk mencoba kembali.",
  ...
  sessionsView: {
    ...
    sessionState: "Status thread",
    all: "Semua",
    sessionArchived: "Thread diarsipkan",
    sessionsArchived: "{count} thread diarsipkan",
    deleteAllArchived: "Hapus semua yang diarsipkan…",
    deleteAllArchivedConfirm: "Hapus {count} thread yang diarsipkan beserta transkripnya?",
    ...
    runFailedReason: "Eksekusi gagal: {reason}",
    ...
    showChildSessions: "Tampilkan {count} sesi turunan untuk {session}",
    hideChildSessions: "Sembunyikan {count} sesi turunan untuk {session}",
    childSessions: "Sesi turunan",
    showMoreChildren: "Tampilkan {count} lagi",
    archived: "Diarsipkan",
    pinned: "Disematkan",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Turunan cloud worker: 1 konflik workspace",
    cloudWorkerDescendantConflicts: "Turunan cloud worker: {count} konflik workspace",
    ...
    customEmoji: "Emoji khusus",
    invalidEmojiIcon: "Masukkan tepat satu emoji.",
  ...
  configForm: {
    showAdvanced: "Tampilkan lanjutan",
    advancedHidden: "{count} pengaturan lanjutan disembunyikan",
    advancedHiddenPlural: "{count} pengaturan lanjutan disembunyikan",
    advancedDivider: "Lanjutan",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Profil gateway Anda",
      assistantIdentity: "Identitas assistant",
      displayName: "Nama tampilan",
      displayNamePlaceholder: "Nama Anda",
      saveProfile: "Simpan nama",
      saving: "Menyimpan…",
      uploading: "Memproses…",
      profileHint:
        "JPEG, PNG, atau WebP. Gambar dipangkas di tengah dan diubah ukurannya menjadi 512px.",
      profileLoadFailed: "Tidak dapat memuat profil Anda.",
      profileSaveFailed: "Tidak dapat menyimpan profil Anda.",
      avatarInvalid: "Pilih gambar JPEG, PNG, atau WebP yang valid.",
      avatarTooLarge: "Avatar yang diproses masih terlalu besar.",
  ...
  configView: {
    ...
    syncedHint: "Disinkronkan di seluruh perangkat Anda melalui gateway.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Bilah Samping",
      hint: "Pilih apa yang muncul saat sesi sedang berjalan.",
      liveActivity: "Tampilkan aktivitas agen langsung di bilah samping",
      liveActivityHint:
        "Tampilkan aktivitas asisten atau alat terbaru di bawah sesi yang berjalan.",
    },
    sessionObserver: {
      title: "Pengamat sesi",
      hint: "Ringkas sesi yang berjalan lama dengan model utilitas kecil.",
      toggle: "Pengamat sesi",
      toggleHint: "Hasilkan ringkasan status langsung untuk sesi Control UI yang berlangganan.",
      resolvedModel: "Model kecil yang di-resolve",
      modelAuto: "auto ({model})",
      modelConfigured: "dikonfigurasi ({model})",
      modelDisabled: "dinonaktifkan",
      modelUnavailable: "tidak tersedia (tidak ada model kecil)",
      modelPicker: "Model kecil",
      modelPickerHint: "Digunakan untuk ringkasan pengamat dan tugas utilitas singkat lainnya.",
      modelCatalogUnavailable: "Katalog model eksplisit tidak tersedia",
      auto: "Auto (default penyedia)",
      disabled: "Dinonaktifkan",
      toggleNote: "Perbarui pengamat sesi Control UI",
      modelNote: "Perbarui model utilitas default",
    },
    connection: {
      title: "Koneksi",
      gateway: "Gateway",
    ...
    rawDiscard: "Buang",
    rawDraftBlocksApply:
      "Perubahan konfigurasi mentah belum disimpan — simpan atau buang di editor Raw sebelum memulai ulang.",
    rawDraftPendingFormTitle:
      "Perubahan konfigurasi mentah belum disimpan — simpan atau buang sebelum beralih ke Form.",
    rawDraftBlocksFormEdit:
      "Perubahan konfigurasi mentah belum disimpan dan tidak dapat diurai; selesaikan di editor Raw sebelum mengubah pengaturan.",
    invalidConfig:
    ...
    formUnsafeCount: "1 pengaturan dalam konfigurasi ini hanya dapat diedit sebagai teks: {paths}",
    formUnsafeCountPlural:
      "{count} pengaturan dalam konfigurasi ini hanya dapat diedit sebagai teks: {paths}",
    formUnsafeMore: "+{count} lainnya",
    openRawEditor: "Buka editor Raw",
  ...
  execApproval: {
    ...
    otherPending: "Permintaan tertunda lainnya",
    reviewRequest: "Tinjau persetujuan dari {agent}: {command}",
    agentPendingOne: "{count} persetujuan tertunda",
    agentPending: "{count} persetujuan tertunda",
  ...
  terminal: {
    ...
    noSessions: "Tidak ada sesi terminal aktif",
    currentSession: "saat ini",
    sessionAttached: "terhubung",
  ...
  subtitles: {
    ...
    apps: "Aplikasi pendamping untuk ponsel, jam, desktop, dan browser.",
    approvals: "Persetujuan eksekusi, plugin, dan agen sistem terbaru.",
    ...
    modelSetup: "Hubungkan model AI terverifikasi",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Bawa memori Codex dan Claude Code ke ruang kerja agen.",
    notifications: "Notifikasi push browser dari gateway Anda.",
    security: "Autentikasi Gateway, kebijakan exec, profil alat, dan persetujuan.",
    advanced: "Semua bagian konfigurasi lainnya, plus editor file mentah.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      recommended: "Direkomendasikan",
      credentialsReady: "Kredensial siap",
      signInNeeded: "Perlu login",
      detected: "Terdeteksi",
      testAndUse: "Uji & gunakan",
    ...
    failure: {
      ...
      rateLimit: "Batas penggunaan tercapai",
    ...
    errors: {
      requestFailed: "Permintaan penyiapan model gagal.",
      activationFailed: "Model tidak dapat diaktifkan.",
    },
    wizard: {
      ...
      continue: "Lanjutkan",
      submit: "Kirim",
      openSignIn: "Buka halaman masuk",
      copy: "Salin",
      expires: "Kedaluwarsa dalam {count} menit",
      cancelled: "Proses masuk ke penyedia dibatalkan.",
      sessionExpired:
        "Sesi penyiapan ini kedaluwarsa setelah Gateway dimulai ulang. Tutup dialog ini, lalu mulai penyiapan model lagi.",
      notComplete: "Proses masuk selesai, tetapi penyiapan model belum lengkap.",
    },
  },
  memoryImport: {
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Pengeditan manual ini tidak lolos validasi konfigurasi.",
      opaqueChange: "Format atau komentar berubah tanpa perubahan path konfigurasi yang terlihat.",
      sources: {
    ...
    nudge: {
      configReload: "Pemuatan ulang konfigurasi terhenti — tanyakan apa yang terjadi",
      channelAuth: "Autentikasi {channel} menurun — tanyakan apa yang terjadi",
      channelDisconnected: "{channel} baru saja terputus — tanyakan apa yang terjadi",
  ...
  mcpServers: {
    ...
    addedSuccess: "Server MCP {name} ditambahkan.",
    enabledSuccess: "Server MCP {name} diaktifkan.",
    disabledSuccess: "Server MCP {name} dinonaktifkan.",
    removedSuccess: "Server MCP {name} dihapus.",
    configUnavailable: "Konfigurasi tidak tersedia; segarkan dan coba lagi.",
    connectRequired: "Sambungkan ke gateway untuk mengubah server MCP.",
    adminRequired: "Perubahan server MCP memerlukan akses operator.admin.",
    enable: "Aktifkan",
    disable: "Nonaktifkan",
  ...
  labsPage: {
    intro:
      "Labs berisi kemampuan eksperimental yang dapat berubah, rusak, atau menghilang antar rilis.",
    sectionTitle: "Fitur eksperimental",
    sectionDescription:
      "Perubahan disimpan langsung dan berlaku untuk pengoperasian agen berikutnya.",
    documentation: "Dokumentasi",
    restartRequired: "Gateway perlu dimulai ulang.",
    saveErrorTitle: "Tidak dapat memperbarui fitur",
    saveFailed: "Pengaturan fitur tidak dapat disimpan.",
    codeMode: {
      title: "Code Mode",
      description:
        "Biarkan agen menggabungkan alat dalam alur kerja JavaScript yang ringkas dan tersandbox.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    havePhone: "Sudah punya aplikasinya?",
    pairDevice: "Pasangkan perangkat Anda",
    sectionWatch: "Di pergelangan tangan Anda",
    sectionDesktop: "Di desktop Anda",
    sectionBrowser: "Di browser Anda",
    sectionCommunity: "Komunitas",
    badgeBundledIos: "Termasuk dengan aplikasi iOS",
    badgeBundledAndroid: "Termasuk dalam aplikasi Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Unduh",
    ctaDocs: "Dokumentasi",
    ctaSetupGuide: "Panduan penyiapan",
    ctaOpenPlugins: "Buka Plugins",
    ctaBrowseClawHub: "Jelajahi ClawHub",
    linkDiscord: "Komunitas Discord",
    linkDocs: "Dokumentasi",
    cards: {
      ios: {
        title: "iPhone",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chat sekilas dan balasan cepat dari pergelangan tangan Anda.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Pendamping menu bar untuk Gateway Anda — notifikasi, persetujuan, chat cepat.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Aplikasi desktop native — build .deb dan AppImage.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Tampilkan siapa yang online",
    rosterTitle: "Online",
    serverRegion: "Server",
    you: "Anda",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Identitas belum diatur.",
      setIdentity: "Atur identitas",
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG, atau WebP. Gambar diubah ukurannya menjadi 256 × 256 atau lebih kecil.",
      chooseAvatar: "Pilih gambar",
      processingAvatar: "Memproses…",
      displayName: "Nama tampilan",
      displayNameDescription: "Ditampilkan kepada orang lain yang menggunakan gateway ini.",
      linkedEmails: "Email tertaut",
      linkedEmailsDescription: "Alamat email yang terhubung dengan profil ini.",
      openSettings: "Buka pengaturan identitas untuk {name}",
      avatarErrors: {
        invalid: "Gambar tersebut tidak dapat diproses.",
        sourceTooLarge: "Pilih gambar berukuran 10 MB atau lebih kecil.",
        tooLarge: "Avatar yang diproses lebih besar dari 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "Log",
    subtitle: "Log berkas Gateway (JSONL).",
    exportButton: "Ekspor {label}",
    exportLabels: {
      filtered: "terfilter",
      visible: "terlihat",
    },
    ...
    autoFollow: "Ikuti otomatis",
    file: "Berkas: {file}",
    truncated: "Keluaran log terpotong; menampilkan bagian terbaru.",
  ...
  board: {
    label: "Dasbor utas",
    tabsLabel: "Tab dasbor",
    moreTabs: "Tab dasbor lainnya",
    gridLabel: "Widget dasbor",
    emptyTitle: "Papan bersih, siap bekerja",
    emptyHint: "Agen Anda dapat menyematkan widget di sini — coba minta kartu status.",
    actionFailed: "Perubahan dasbor tidak dapat disimpan.",
    actionInProgress: "Perubahan dasbor lain masih sedang disimpan.",
    announcement: {
      moved: "Memindahkan {title}.",
      resized: "Mengubah ukuran {title}.",
      removed: "Menghapus {title}.",
      granted: "Akses widget diizinkan.",
      rejected: "Akses widget ditolak.",
    },
    widget: {
      cellLabel:
        "Widget dasbor: {title}. Gunakan tombol panah untuk menavigasi. Tahan Alt dan tekan tombol panah untuk memindahkannya.",
      moveHandle: "Pindahkan {title}",
      resizeHandle: "Ubah ukuran {title}",
      menuLabel: "Opsi widget",
      moveToTab: "Pindahkan ke tab",
      noOtherTabs: "Tidak ada tab lain",
      resize: "Ubah ukuran",
      autoHeight: "Tinggi otomatis",
      remove: "Hapus",
      ...
      activeCapabilities: "Kapabilitas widget aktif",
      ...
      appStaleTitle: "Aplikasi yang disematkan ini sudah usang",
      appStaleDetail: "Server, sumber daya, atau transkrip asalnya tidak lagi tersedia.",
      retry: "Coba lagi",
      ...
      frameAuthorizationFailed:
        "Otorisasi widget gagal setelah beberapa kali percobaan penyegaran.",
      sandboxOriginRequired:
        "Otorisasi widget gagal setelah beberapa kali percobaan penyegaran. Jika gateway berjalan di belakang reverse proxy atau tunnel yang tidak merutekan port sandbox widget, atur mcp.apps.sandboxOrigin ke origin publik khusus yang dirutekan ke listener sandbox.",
      errorTitle: "Widget ini tidak dapat dimuat",
      errorDetail: "Masalah ini terbatas pada kartu ini.",
      actionErrorTitle: "Perubahan widget gagal",
      actionErrorDetail: "Dasbor mempertahankan status widget sebelumnya.",
      errorShow: "Tampilkan detail",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Memuat widget plugin…",
      disabledPlugin: "Widget dari plugin yang dinonaktifkan {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "Kartu Workboard",
      summaryLabel: "Ringkasan Workboard",
      loading: "Memuat Workboard…",
      cardIdRequired: "Widget ini memerlukan prop cardId.",
      cardMissing: "Kartu Workboard ini tidak lagi tersedia.",
      unassigned: "Belum ditetapkan",
      openBoard: "Buka papan",
      statusCounts: "Kartu berdasarkan status",
      noActiveCards: "Tidak ada kartu yang siap atau sedang berjalan.",
    },
    ...
    dashboardEmpty: "Belum ada dasbor — agen yang bekerja dapat menyematkan widget.",
    openSession: "Buka sesi",
  ...
  attention: {
    ...
    pendingApproval: "{count} persetujuan tertunda",
    pendingApprovals: "{count} persetujuan tertunda",
  },
  approvalHistory: {
    description:
      "Persetujuan eksekusi terminal, plugin, dan agen sistem yang dicatat oleh Gateway ini, dari yang terbaru.",
    loading: "Memuat riwayat persetujuan…",
    loadingMore: "Memuat…",
    loadMore: "Muat lebih banyak",
    empty: "Tidak ada persetujuan yang telah diselesaikan dalam periode berjalan 30 hari.",
    retention: "Riwayat persetujuan disimpan dalam periode berjalan 30 hari.",
    offline: "Hubungkan ke Gateway untuk memuat riwayat persetujuan.",
    invalidResponse: "Gateway mengembalikan respons riwayat persetujuan yang tidak valid.",
    unknown: "Tidak diketahui",
    notApplicable: "N/A",
    columns: {
    ...
    decisions: {
      ...
      allowAlways: "Selalu izinkan",
      deny: "Tolak",
    },
    reasons: {
      user: "Keputusan pengguna",
      timeout: "Waktu habis",
      malformedVerdict: "Putusan tidak valid",
      noRoute: "Tidak ada rute",
      runAborted: "Eksekusi dibatalkan",
      gatewayRestart: "Gateway dimulai ulang",
      storageCorrupt: "Penyimpanan rusak",
    },
  },
  palette: {
  ...
  usage: {
    ...
    details: {
      ...
      loadFailed: "Tidak dapat memuat {detail}: {error}",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      loadFailed: "Tidak dapat memuat permintaan pemasangan untuk browser ini: {error}",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Thread beralih cabang — tinjau dan kirim ulang.",
    },
    waitingForApproval: "Menunggu persetujuan…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      suggest: "Sarankan",
      draft: "Draf",
      publishDraft: "Terbitkan draf",
      members: "Anggota",
      selected: "Anggota",
      noPeople: "Tidak ada orang yang dipasangkan.",
      readOnlyNotice: "Hanya pemilik utas dan anggota yang dapat bertindak di utas ini.",
    },
    sessionSuggestions: {
      suggest: "Sarankan",
    ...
    sessionHeader: {
      ...
      untitledBranch: "Cabang tanpa judul",
    ...
    board: {
      ...
      chatFace: "Chat",
      dashboardFace: "Dasbor",
      dockMenu: "Dok chat: {dock}",
      dockLeft: "Dok chat ke kiri",
      dockRight: "Dok chat ke kanan",
      dockBottom: "Dok chat ke bawah",
      dockHidden: "Sembunyikan chat",
      resizeDock: "Ubah ukuran dok chat",
      reopenChat: "Tampilkan chat",
      workboardCard: "Kartu workboard: {title}, {status}",
      defaultTab: "Utama",
      mockPlaceholder: "Seam tampilan papan · {tabs} tab · {widgets} widget",
      mockOverview: "Ikhtisar",
      mockResearch: "Riset",
      mockSessionStatus: "Status utas",
      mockRecentFindings: "Temuan terbaru",
      mockSourceMap: "Peta sumber",
      resetTitle: "Setel ulang percakapan?",
      resetDescription: "Konteks percakapan disetel ulang. Dasbor Anda tetap ada.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      inspectCloud: "Periksa versi cloud pertama",
      takeCloud: "Ambil versi cloud pertama",
      copyInspectCommand: "Salin perintah inspect cloud",
      copyTakeCommand: "Salin perintah take-cloud",
      commandHelp:
      ...
      eventTitleMany: "Hasil cloud diterapkan dengan {count} konflik",
      eventDescription:
        "Versi lokal dipertahankan untuk path ini; perubahan cloud lainnya diterapkan.",
    },
    compaction: {
    ...
    questions: {
      ...
      skipping: "Melewati…",
      skipped: "Dilewati",
      collapse: "Ciutkan pertanyaan",
      expand: "Perluas pertanyaan",
      eyebrow: "Pertanyaan",
      cardLabel: "Pertanyaan dari asisten",
      summaryLabel: "Hasil pertanyaan",
      timeRemaining: "Sisa waktu",
      ownAnswer: "Jawaban Anda sendiri…",
      ownAnswerFor: "Jawaban Anda sendiri untuk {header}",
      submitting: "Mengirim…",
      submitFailed: "Tidak dapat mengirim: {error}",
      answered: "Terjawab",
      answeredElsewhere: "Terjawab di tempat lain",
      unavailable: "Tidak tersedia",
      expired: "Kedaluwarsa",
      cancelled: "Dibatalkan",
    },
    imageLightbox: {
      label: "Pratinjau gambar: {title}",
      open: "Buka gambar {title}",
    ...
    messages: {
      activity: "Aktivitas",
      copySelection: "Salin",
      forkFromHere: "Cabang dari sini",
      hide: "Sembunyikan",
      hideConfirm: "Sembunyikan pesan ini di browser ini? Agen masih dapat melihatnya.",
      hideMessage: "Sembunyikan pesan",
      hideTooltip: "Sembunyikan hanya di browser ini",
      ...
      rewindUnavailable: "Putar ulang tidak tersedia saat agen sedang bekerja",
      forkUnavailable: "Fork tidak tersedia saat agen sedang bekerja",
    ...
    modelControls: {
      ...
      reasoning: "Penalaran",
      speed: "Kecepatan",
      sessionOverride: "Penggantian thread",
      usingDefault: "Menggunakan default dari Pengaturan",
      resetToDefault: "Setel ulang ke default ({model})",
    },
    rail: {
      title: "Pendamping sesi",
      subtitle: "Tanyakan tentang sesi ini atau proyeknya",
      expand: "Perluas panel sesi",
      collapse: "Ciutkan panel sesi",
      hide: "Sembunyikan panel sesi",
      show: "Tampilkan panel sesi",
      clear: "Bersihkan utas pendamping",
      plan: "Rencana",
      progress: "{completed} dari {total}",
      pullRequests: "Pull request",
      checksPassing: "{count} lulus",
      checksFailing: "{count} gagal",
      checksPending: "{count} berjalan",
      finished: "Selesai {time}",
      empty: "Ajukan pertanyaan hanya-baca tentang sesi ini atau proyeknya.",
      askLabel: "Tanya pendamping sesi",
      askPlaceholder: "Apa yang perlu saya ketahui?",
      askSubmit: "Tanya",
      askPending: "Memeriksa sesi…",
      askBusy: "Pendamping sedang menjawab pertanyaan lain.",
      askUnavailable: "Pendamping tidak dapat menjawab saat ini.",
      asOf: "per {time}",
      health: {
        "on-track": "Sesuai rencana",
        grinding: "Bekerja",
        stuck: "Terhenti",
        "waiting-on-user": "Menunggu Anda",
        "wrapping-up": "Menyelesaikan",
        done: "Selesai",
        failed: "Gagal",
      },
    },
    observer: {
      ...
      plan: "Rencana",
      progress: "{completed} dari {total}",
      boardCurrentStatus: "Status saat ini",
      boardTimeline: "Linimasa kesehatan",
      boardCurrentRun: "Proses saat ini",
      boardPreviousRun: "Proses sebelumnya",
      boardUnknownRun: "Proses tidak teridentifikasi",
      boardSinceYouLeft: "Sejak Anda pergi",
      health: {
        "on-track": "Sesuai rencana",
        grinding: "Bekerja",
        stuck: "Terhenti",
    ...
    composer: {
      ...
      offlineQueuedHint: "Luring — {count} dalam antrean; pesan terkirim saat koneksi kembali.",
      ...
      cameraAccessFailed: "Tidak dapat mengakses kamera.",
      cameraBusy: "Kamera sedang sibuk atau tidak tersedia untuk browser.",
      cameraFallback: "Kamera {number}",
      cameraInput: "Kamera",
      cameraListUnsupported: "Browser ini tidak dapat menampilkan daftar kamera.",
      cameraNoneFound: "Tidak ada kamera yang ditemukan.",
      cameraPageInactive: "Kamera tidak tersedia saat halaman ini tidak aktif.",
      ...
      microphoneAppliesNextSession: "Perubahan berlaku saat Anda memulai sesi Talk berikutnya.",
      microphoneListUnsupported: "Browser ini tidak dapat menampilkan daftar input mikrofon.",
      noCameras: "Tidak ada kamera tambahan yang ditemukan",
      ...
      holdToRecordSetting: "Tahan tombol mikrofon untuk mendikte",
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon pada composer, bicaralah, lalu lepaskan untuk menyisipkan teks tanpa mengirim.",
      dictationAudioUnsupported: "Gateway mengembalikan format audio dikte yang tidak didukung.",
      dictationBrowserAudioUnsupported: "Browser ini tidak dapat menangkap audio dikte pada 8 kHz.",
      dictationConnecting: "Memulai dikte…",
      dictationDisconnected: "Dikte dihentikan karena Gateway terputus.",
      dictationFailed: "Dikte gagal.",
      dictationFinalizing: "Menyelesaikan dikte…",
      dictationFinalizationTimedOut:
        "Dikte dihentikan sebelum transkrip parsial terakhir dapat diselesaikan.",
      dictationProviderUnavailable:
        "Tidak ada penyedia transkripsi yang dikonfigurasi untuk dikte.",
      dictationRecording: "Merekam {elapsed}",
      dictationReleaseToInsert: "Lepaskan untuk menyisipkan dikte",
      ...
      selectedCameraUnavailable:
        "Kamera yang dipilih tidak tersedia. Pilih kamera lain atau System default.",
      ...
      systemDefaultCamera: "Default sistem",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Widget ini perlu dirender ulang untuk diekspor sebagai gambar.",
      widgetExportFailed: "Ekspor widget gagal. Coba lagi.",
      pinToDashboard: "Sematkan ke dasbor",
      pinToDashboardPending: "Menyematkan…",
      pinnedToDashboard: "Disematkan",
    ...
    backgroundTasks: {
      ...
      expandTask: "Tampilkan detail untuk {title}",
      detailTitle: "Detail tugas",
      backToTasks: "Kembali ke tugas latar belakang",
      detailLoading: "Memuat detail tugas…",
      detailFailed: "Tidak dapat memuat detail tugas.",
      prompt: "Prompt",
      output: "Output",
      promptUnavailable: "Prompt tidak tersedia.",
      outputPending: "Belum ada output.",
    },
    sessionDiff: {
      title: "Perubahan",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Diskusi ini tidak dapat disematkan.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Berjalan setiap detik",
      ...
      summaryEverySeconds: "Berjalan setiap {amount} detik",
      ...
      script: "Skrip",
      readOnlyPayloadHelp:
        "Payload ini dibuat di luar Control UI. Isinya tetap hanya-baca dan dipertahankan saat Anda menyimpan perubahan lain.",
