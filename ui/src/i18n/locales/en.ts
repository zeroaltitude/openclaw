...
export const en: TranslationMap & {
  ...
  tasksPage: {
    supervision: {
      ...
      steer: "Send instructions",
      resume: "Start the next episode",
      minutes: "New episode time limit (minutes)",
      attempts: "Maximum attempts",
      attemptSeconds: "Attempt time limit (seconds)",
      inspectArtifact: "Inspect retained files",
      download: "Download verified file",
      previewLimit:
        "Text preview shows at most 64 KiB; download includes the complete verified file.",
      artifact: "Retained artifact digest",
      approved: "Accepted for this artifact",
      approve: "I reviewed and accept this artifact",
      controlFailed: "Could not apply this control. Refresh the task before trying again.",
      ...
      phase: {
        ...
        succeeded: "Succeeded",
        partial: "Accepted partial result",
        input_required: "Input required",
        failed: "Failed",
        cancelled: "Cancelled",
        quarantined: "Record requires repair",
      },
      custody: {
        armed: "Continuation owned",
        unknown: "Continuation not currently confirmed",
        stopped: "Continuation stopped",
      },
      delivery: {
        pending: "Pending",
        queued: "Queued",
