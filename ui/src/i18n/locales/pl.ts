...
export const pl: TranslationMap = {
  common: {
    ...
    refresh: "Odśwież",
    retry: "Ponów",
    staleData: "Wyświetlane są nieaktualne dane.",
    reload: "Przeładuj",
    reset: "Resetuj",
    restore: "Przywróć",
  ...
  channels: {
    ...
    pairing: {
      title: "Prośby o dostęp do wiadomości bezpośrednich",
      subtitle:
        "Przejrzyj osoby oczekujące na wysłanie wiadomości bezpośrednich do kanałów chronionych parowaniem.",
      channelFilter: "Kanał",
      accountFilter: "Konto",
      ...
      approve: "Zatwierdź",
      dismiss: "Odrzuć",
      approveAria: "Zatwierdź {sender} dla {channel}, konto {account}",
      dismissAria: "Odrzuć {sender} dla {channel}, konto {account}",
      requested: "Poproszono {ago}",
      expires: "Wygasa {ago}",
      senderDetails: "Szczegóły nadawcy",
      missingPermission:
        "To połączenie nie ma dostępu operator.pairing, więc nie można przeglądać próśb o wiadomości bezpośrednie.",
      noAccounts:
        "Żadne skonfigurowane konto kanału nie używa parowania nadawców wiadomości bezpośrednich.",
      noRequests: "Brak oczekujących próśb o dostęp do wiadomości bezpośrednich.",
      noFilteredRequests: "Żadna oczekująca prośba nie pasuje do tych filtrów.",
      limits:
        "Prośby wygasają po {minutes} minutach. Każde konto kanału może przechowywać do {count} oczekujących próśb.",
      detailTitle: "Dostęp do wiadomości bezpośrednich",
      detailSubtitle:
        "Osoby muszą zostać zatwierdzone, zanim ich wiadomości bezpośrednie dotrą do agenta.",
      pendingCount: "{count} oczekujących",
      noPending: "Brak oczekujących żądań",
      review: "Przejrzyj żądania",
      approveDialogTitle: "Zatwierdź dostęp do wiadomości bezpośrednich",
      dismissDialogTitle: "Odrzuć żądanie dostępu do wiadomości bezpośrednich",
      approveExplanation:
        "Umożliwia to nadawcy rozmowę z agentem w wiadomościach bezpośrednich. Nie przyznaje dostępu do grup.",
      dismissExplanation:
        "Usuwa to bieżące żądanie, ale nie blokuje nadawcy. Może on ponownie poprosić o dostęp później.",
      notifyRequester: "Powiadom osobę zgłaszającą po zatwierdzeniu",
      makeCommandOwner: "Uczyń również tego nadawcę pierwszym właścicielem poleceń",
      commandOwnerHelp:
        "Właściciele poleceń mogą uruchamiać uprzywilejowane polecenia i zatwierdzać niebezpieczne działania. Ta opcja jest dostępna tylko wtedy, gdy nie skonfigurowano żadnego właściciela.",
      commandOwnerNeedsAdmin:
        "Nie skonfigurowano właściciela poleceń. To połączenie wymaga uprawnień operator.admin, aby przypisać pierwszego właściciela.",
      approvedNotice: "Dostęp do wiadomości bezpośrednich zatwierdzony.",
      approvedOwnerNotice:
        "Dostęp do wiadomości bezpośrednich zatwierdzony i skonfigurowano pierwszego właściciela poleceń.",
      approvedNotificationFailedNotice:
        "Dostęp do wiadomości bezpośrednich zatwierdzony, ale nie udało się dostarczyć powiadomienia do osoby zgłaszającej.",
      approvedOwnerFailedNotice:
        "Dostęp do wiadomości bezpośrednich zatwierdzony, ale nie udało się skonfigurować pierwszego właściciela poleceń.",
      approvedFollowupsFailedNotice:
        "Dostęp do wiadomości bezpośrednich zatwierdzony, ale nie powiodło się zarówno powiadomienie osoby zgłaszającej, jak i konfiguracja właściciela poleceń.",
      dismissedNotice:
        "Żądanie dostępu do wiadomości bezpośrednich odrzucone. Nadawca może ponownie poprosić o dostęp.",
    },
    setup: {
      ...
      working: "Pracuje…",
      sessionExpired:
        "Ta sesja konfiguracji wygasła po ponownym uruchomieniu Gateway. Zamknij to okno, a następnie ponownie rozpocznij konfigurację kanału.",
      continue: "Kontynuuj",
      finish: "Zakończ",
      copyText: "Kopiuj",
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie usunięto żadnej zapisanej sesji WhatsApp. Możliwe, że już jej nie ma lub jej katalog uwierzytelniania wymaga ręcznego wyczyszczenia.",
    },
  ...
  agentChip: {
    ...
    agents: "Agenci",
    openChat: "Czat z {name}",
    offlineOpenSettings: "Offline — otwórz Ustawienia",
    switchAgent: "Przełącz agenta",
    working: "Pracuje…",
  ...
  newSession: {
    ...
    cloudWorker: "Chmura · {profile}",
    cloudWorkerProvider: "Dostawca workera chmurowego: {provider}",
    cloudRequiresWorktree: "Workery chmurowe wymagają zarządzanego drzewa roboczego",
    cloudRequiresOpenClawRuntime:
      "Procesy w chmurze wymagają środowiska OpenClaw; wybrano {runtime}.",
    ...
    cloudSyncsFolder: "Synchronizuje {folder} z procesem roboczym w chmurze",
    folder: "Folder",
    folderPlaceholder: "Obszar roboczy agenta",
    places: "Miejsca",
    recentFolders: "Ostatnie",
    runsOn: "Działa na {place}",
    ...
    incognitoDescription: "Zachowaj ten wątek tylko do ponownego uruchomienia Gateway",
    startAsDraft: "Rozpocznij jako wersję roboczą",
    messagePlaceholder: "Nad czym ma pracować ta sesja?",
    readingAttachment: "Odczytywanie załącznika",
  ...
  sessionsView: {
    ...
    global: "Globalne",
    unknown: "Nieznane",
    sessionState: "Stan wątku",
    all: "Wszystkie",
    sessionArchived: "Wątek zarchiwizowany",
    sessionsArchived: "Zarchiwizowano {count} wątków",
    deleteAllArchived: "Usuń wszystkie zarchiwizowane…",
    deleteAllArchivedConfirm: "Usunąć {count} zarchiwizowanych wątków i ich transkrypcje?",
    ...
    runFailedReason: "Uruchomienie nie powiodło się: {reason}",
    ...
    lastActive: "Ostatnia aktywność {time}",
    ...
    showChildSessions: "Pokaż sesje podrzędne ({count}) dla sesji {session}",
    hideChildSessions: "Ukryj sesje podrzędne ({count}) dla sesji {session}",
    childSessions: "Sesje podrzędne",
    showMoreChildren: "Pokaż jeszcze {count}",
    archived: "Zarchiwizowano",
    pinned: "Przypięte",
    unread: "Unread",
    worktreeSession: "Worktree session",
    automationAttached: "Automation attached",
    incognito: "Wątek incognito",
    cloudWorkerPlacement: "Worker chmurowy: {state}",
    cloudWorkerPlacementConflict: "Cloud worker: {state} · 1 konflikt obszaru roboczego",
    cloudWorkerPlacementConflicts: "Cloud worker: {state} · {count} konfliktów obszarów roboczych",
    cloudWorkerDescendantConflict: "Element podrzędny cloud worker: 1 konflikt obszaru roboczego",
    cloudWorkerDescendantConflicts:
      "Elementy podrzędne cloud worker: {count} konfliktów obszarów roboczych",
    ...
    customEmoji: "Niestandardowe emoji",
    invalidEmojiIcon: "Wprowadź dokładnie jedno emoji.",
    ...
    stopCloudWorker: "Zatrzymaj proces roboczy w chmurze…",
    stopCloudWorkerConfirm: "Zatrzymać proces roboczy w chmurze dla sesji „{session}”?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Twój profil Gateway",
      assistantIdentity: "Tożsamość asystenta",
      displayName: "Nazwa wyświetlana",
      displayNamePlaceholder: "Twoje imię",
      saveProfile: "Zapisz imię",
      saving: "Zapisywanie…",
      uploading: "Przetwarzanie…",
      profileHint: "JPEG, PNG lub WebP. Obrazy są przycinane do środka i skalowane do 512 px.",
      profileLoadFailed: "Nie można załadować Twojego profilu.",
      profileSaveFailed: "Nie można zapisać Twojego profilu.",
      avatarInvalid: "Wybierz prawidłowy obraz JPEG, PNG lub WebP.",
      avatarTooLarge: "Przetworzony awatar jest nadal zbyt duży.",
  ...
  configView: {
    ...
    sections: {
      ...
      security: "Zasady bezpieczeństwa",
      plugins: "Wtyczki",
      gateway: "Gateway",
      web: "Sieć",
    ...
    syncedHint: "Synchronizowane między Twoimi urządzeniami przez Gateway.",
    notifications: {
      title: "Powiadomienia push",
      nativeTitle: "Powiadomienia",
      hint: "Odbieraj powiadomienia push w przeglądarce z Twojego gatewaya.",
      nativeHint: "Powiadomienia są wyświetlane natywnie przez aplikację OpenClaw na tym Macu.",
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Opcjonalna szerokość CSS wyśrodkowanej transkrypcji, np. 960px, 82% lub min(1280px, 82%).",
      messageWidthInvalid:
        "Wprowadź szerokość CSS, np. 960px, 82%, min(1280px, 82%) lub calc(100% - 2rem).",
    },
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma być wyświetlane podczas działających sesji.",
      liveActivity: "Pokaż aktywność agenta na żywo na pasku bocznym",
      liveActivityHint:
        "Pokaż najnowszą aktywność asystenta lub narzędzia pod działającymi sesjami.",
    },
    sessionObserver: {
      title: "Obserwator sesji",
      hint: "Podsumowuj długotrwałe sesje za pomocą małego modelu narzędziowego.",
      toggle: "Obserwator sesji",
      toggleHint: "Generuj podsumowania statusu na żywo dla subskrybowanych sesji Control UI.",
      resolvedModel: "Rozpoznany mały model",
      modelAuto: "auto ({model})",
      modelConfigured: "skonfigurowany ({model})",
      modelDisabled: "wyłączone",
      modelUnavailable: "niedostępny (brak małego modelu)",
      modelPicker: "Mały model",
      modelPickerHint: "Używany do podsumowań obserwatora i innych krótkich zadań narzędziowych.",
      modelCatalogUnavailable: "Jawny katalog modeli niedostępny",
      auto: "Auto (domyślny dostawcy)",
      disabled: "Wyłączone",
      toggleNote: "Zaktualizuj obserwatora sesji Control UI",
      modelNote: "Zaktualizuj domyślny model narzędziowy",
    },
    connection: {
      title: "Połączenie",
      gateway: "Gateway",
    ...
    rawDraftPendingFormTitle:
      "Niezapisane zmiany w surowej konfiguracji — zapisz je lub odrzuć przed przełączeniem na formularz.",
    rawDraftBlocksFormEdit:
      "Nie udało się przetworzyć niezapisanych zmian w surowej konfiguracji; rozwiąż je w edytorze Raw przed zmianą ustawień.",
    invalidConfig:
    ...
    formUnsafeCount: "1 ustawienie w tej konfiguracji można edytować tylko jako tekst: {paths}",
    formUnsafeCountPlural:
      "Ustawień w tej konfiguracji, które można edytować tylko jako tekst: {count}: {paths}",
    formUnsafeMore: "+{count} więcej",
    openRawEditor: "Otwórz edytor Raw",
  ...
  execApproval: {
    ...
    otherPending: "Inne oczekujące żądania",
    reviewRequest: "Sprawdź zatwierdzenie od {agent}: {command}",
    agentPendingOne: "{count} oczekujące zatwierdzenie",
    agentPending: "{count} oczekujących zatwierdzeń",
  ...
  nav: {
    ...
    settingsGroupSecurity: "Prywatność i bezpieczeństwo",
  ...
  terminal: {
    ...
    uploadProgress: "Przesyłanie {current} z {total}",
    ...
    noSessions: "Brak aktywnych sesji terminala",
    currentSession: "bieżąca",
    sessionAttached: "podłączona",
    attachSession: "Podłącz sesję",
    attachFailed: "Nie udało się podłączyć sesji terminala",
    starting: "Starting terminal…",
    connecting: "Łączenie z sesją…",
  ...
  tabs: {
    ...
    modelSetup: "Konfiguracja modelu",
  ...
  subtitles: {
    ...
    apps: "Aplikacje towarzyszące na telefon, zegarek, komputer i przeglądarkę.",
    ...
    modelSetup: "Połącz zweryfikowany model AI",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Przenieś pamięć Codex i Claude Code do obszaru roboczego agenta.",
    notifications: "Powiadomienia push w przeglądarce z Twojego gateway.",
    security: "Uwierzytelnianie Gateway, zasady exec, profil narzędzi i zatwierdzenia.",
    advanced: "Wszystkie pozostałe sekcje konfiguracji oraz edytor plików surowych.",
  ...
  modelSetup: {
    ...
    candidates: {
      title: "Znaleziono w tym Gateway",
      recommended: "Zalecane",
      credentialsReady: "Dane uwierzytelniające są gotowe",
      signInNeeded: "Wymagane logowanie",
      detected: "Wykryto",
      testAndUse: "Przetestuj i użyj",
    ...
    prepare: {
      ...
      llamaCppHint: "Pobierz model lokalny o rozmiarze około 5,0 GB; wymaga 16 GB RAM",
    },
    manual: {
      title: "Połącz za pomocą klucza API lub tokenu",
      provider: "Dostawca",
      selectProvider: "Wybierz dostawcę",
      accessValue: "Klucz API lub token",
      accessValuePlaceholder: "Wklej klucz API lub token",
      connect: "Połącz",
      required: "Wybierz dostawcę i wprowadź klucz API lub token.",
    },
    success: {
    ...
    failure: {
      ...
      rateLimit: "Przekroczono limit żądań",
      billing: "Problem z rozliczeniem",
    ...
    errors: {
      requestFailed: "Żądanie konfiguracji modelu nie powiodło się.",
      activationFailed: "Nie udało się aktywować modelu.",
    },
    wizard: {
      ...
      continue: "Kontynuuj",
      submit: "Prześlij",
      openSignIn: "Otwórz stronę logowania",
      copy: "Kopiuj",
      expires: "Wygasa za {count} min",
      cancelled: "Logowanie u dostawcy zostało anulowane.",
      sessionExpired:
        "Ta sesja konfiguracji wygasła po ponownym uruchomieniu Gateway. Zamknij to okno, a następnie ponownie rozpocznij konfigurację modelu.",
      notComplete: "Logowanie zakończone, ale konfiguracja modelu nie jest jeszcze kompletna.",
    },
  },
  memoryImport: {
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Twój przewodnik po konfiguracji systemu",
    subtitleCaretaker: "Konfiguracja i utrzymanie systemu.",
    exitSetup: "Zakończ konfigurację",
    newAgent: "Nowy agent",
    hatchDraft: "Obudź się, przyjacielu!",
    placeholder: "Napisz do OpenClaw…",
    sensitivePlaceholder: "Wprowadź wrażliwą wartość…",
    sensitiveReply: "Wysłano wrażliwą odpowiedź",
    send: "Wyślij",
    thinking: "OpenClaw myśli",
    earlier: "Wcześniej",
    requestFailed: "OpenClaw nie mógł odpowiedzieć. Spróbuj ponownie.",
    connectionChanged:
      "Połączenie z Gateway zmieniło się. Ponów próbę, aby kontynuować tę konfigurację.",
    sessionRestarted:
      "{error} OpenClaw rozpoczął nową sesję; wcześniejsze wiadomości pozostają jako kontekst.",
    unsupportedGateway: "Zaktualizuj Gateway, aby kontynuować konfigurację z OpenClaw.",
    history: {
      button: "Historia",
      title: "Ostatnie zmiany",
      description: "Co zmieniło się w tym systemie, od najnowszych.",
      loading: "Wczytywanie ostatnich zmian…",
      empty: "Brak zarejestrowanych zmian.",
      requestFailed: "OpenClaw nie mógł wczytać historii zmian.",
      loadMore: "Wczytaj więcej",
      loadingMore: "Wczytywanie kolejnych…",
      changedPaths: "Zmienione ścieżki ({count})",
      invalidEdit: "Ta ręczna edycja nie przeszła walidacji konfiguracji.",
      opaqueChange:
        "Zmieniono formatowanie lub komentarze bez widocznych zmian ścieżki konfiguracji.",
      sources: {
    ...
    nudge: {
      configReload: "Przeładowanie konfiguracji zatrzymane — zapytaj mnie, co się stało",
      channelAuth: "Uwierzytelnianie {channel} pogorszone — zapytaj mnie, co się stało",
      channelDisconnected: "{channel} właśnie się rozłączył — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    addedSuccess: "Dodano serwer MCP {name}.",
    enabledSuccess: "Włączono serwer MCP {name}.",
    disabledSuccess: "Wyłączono serwer MCP {name}.",
    removedSuccess: "Usunięto serwer MCP {name}.",
    configUnavailable: "Konfiguracja jest niedostępna; odśwież i spróbuj ponownie.",
    connectRequired: "Połącz się z Gateway, aby zmienić serwery MCP.",
    adminRequired: "Zmiany serwerów MCP wymagają dostępu operator.admin.",
    enable: "Włącz",
    disable: "Wyłącz",
  ...
  labsPage: {
    intro:
      "Labs zawiera eksperymentalne funkcje, które mogą się zmieniać, przestać działać lub zniknąć między wydaniami.",
    sectionTitle: "Funkcje eksperymentalne",
    sectionDescription:
      "Zmiany zapisują się natychmiast i mają zastosowanie do przyszłych uruchomień agenta.",
    documentation: "Dokumentacja",
    restartRequired: "Wymagane ponowne uruchomienie Gateway.",
    saveErrorTitle: "Nie można zaktualizować funkcji",
    saveFailed: "Nie można zapisać ustawienia funkcji.",
    codeMode: {
      title: "Tryb kodu",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowych, izolowanych przepływach pracy JavaScript.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "Zabierz OpenClaw wszędzie",
    heroTagline:
      "Aplikacje towarzyszące na telefon, zegarek, komputer i przeglądarkę — plus wtyczki rozszerzające możliwości Twojego agenta.",
    sectionMobile: "Na telefonie",
    havePhone: "Masz już aplikację?",
    pairDevice: "Sparuj swoje urządzenie",
    sectionWatch: "Na nadgarstku",
    sectionDesktop: "Na komputerze",
    sectionBrowser: "W przeglądarce",
    sectionCommunity: "Społeczność",
    badgeBundledIos: "Dołączone do aplikacji iOS",
    badgeBundledAndroid: "Dołączone do aplikacji Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Pobierz",
    ctaDocs: "Dokumentacja",
    ctaSetupGuide: "Przewodnik konfiguracji",
    ctaOpenPlugins: "Otwórz wtyczki",
    ctaBrowseClawHub: "Przeglądaj ClawHub",
    linkDiscord: "Społeczność Discord",
    linkDocs: "Dokumentacja",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Czatuj, rozmawiaj, zatwierdzaj działania i udostępniaj do OpenClaw z iOS.",
      },
      android: {
        title: "Android",
        desc: "Twój telefon z Androidem jako pełnoprawny węzeł OpenClaw — czat, aparat i Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Czaty na pierwszy rzut oka i szybkie odpowiedzi z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Aplikacja towarzysząca na Androida rozszerza OpenClaw na zegarek.",
      },
      macos: {
        title: "macOS",
        desc: "Aplikacja towarzysząca w pasku menu dla Twojego Gateway — powiadomienia, zatwierdzenia, szybki czat.",
      },
      windows: {
        title: "Windows",
        desc: "Aplikacja towarzysząca dla Windows łączy Twój komputer jako węzeł OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Natywna aplikacja desktopowa — wersje .deb i AppImage.",
      },
      chrome: {
        title: "Rozszerzenie Chrome",
        desc: "Pozwól OpenClaw sterować istniejącym Chrome — kartami, stronami i formularzami.",
      },
      plugins: {
        title: "Wtyczki i ClawHub",
        desc: "Rozszerz OpenClaw o kanały, narzędzia i Skills od społeczności.",
      },
    },
  },
  presence: {
    rosterLabel: "Pokaż, kto jest online",
    rosterTitle: "Online",
    serverRegion: "Serwer",
    you: "ty",
  },
  profilePage: {
    ...
    identity: {
      title: "Tożsamość",
      menuLabel: "Menu tożsamości",
      menuButtonLabel: "Menu tożsamości i aplikacji dla {name}",
      description: "Twój profil na tym gatewayu.",
      loading: "Ładowanie tożsamości…",
      profileUnavailable: "Nie udało się załadować profilu tożsamości.",
      notSet: "Tożsamość nie jest ustawiona.",
      setIdentity: "Ustaw tożsamość",
      avatar: "Awatar",
      avatarDescription: "PNG, JPEG lub WebP. Obrazy są zmniejszane do 256 × 256 lub mniej.",
      chooseAvatar: "Wybierz obraz",
      processingAvatar: "Przetwarzanie…",
      displayName: "Nazwa wyświetlana",
      displayNameDescription: "Widoczne dla innych osób korzystających z tego gatewaya.",
      linkedEmails: "Powiązane adresy e-mail",
      linkedEmailsDescription: "Adresy e-mail połączone z tym profilem.",
      openSettings: "Otwórz ustawienia tożsamości dla {name}",
      avatarErrors: {
        invalid: "Nie udało się przetworzyć tego obrazu.",
        sourceTooLarge: "Wybierz obraz o rozmiarze 10 MB lub mniejszym.",
        tooLarge: "Przetworzony awatar jest większy niż 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "Dzienniki",
    subtitle: "Dzienniki plików Gateway (JSONL).",
    exportButton: "Eksportuj {label}",
    exportLabels: {
      filtered: "przefiltrowane",
      visible: "widoczne",
    },
    filter: "Filtr",
    searchPlaceholder: "Przeszukaj dzienniki",
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Dane wyjściowe dziennika skrócone; wyświetlanie najnowszego fragmentu.",
  ...
  board: {
    label: "Pulpit wątków",
    tabsLabel: "Karty pulpitu",
    moreTabs: "Więcej kart pulpitu",
    gridLabel: "Widżety pulpitu",
    emptyTitle: "Czysta tablica, gotowa do pracy",
    emptyHint: "Twój agent może przypiąć tutaj widżety — spróbuj poprosić o kartę statusu.",
    actionFailed: "Nie udało się zapisać zmiany pulpitu.",
    actionInProgress: "Inna zmiana pulpitu jest wciąż zapisywana.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Zezwolono na dostęp widżetu.",
      rejected: "Odrzucono dostęp widżetu.",
    },
    widget: {
      cellLabel:
        "Widżet pulpitu: {title}. Użyj klawiszy strzałek, aby nawigować. Przytrzymaj Alt i naciśnij klawisz strzałki, aby go przenieść.",
      moveHandle: "Przenieś {title}",
      resizeHandle: "Zmień rozmiar {title}",
      menuLabel: "Opcje widżetu",
      moveToTab: "Przenieś do karty",
      noOtherTabs: "Brak innych kart",
      resize: "Zmień rozmiar",
      autoHeight: "Automatyczna wysokość",
      remove: "Usuń",
      needsApproval: "Wymaga zatwierdzenia",
      needsApprovalDetail: "Ten widżet zażądał dodatkowego dostępu.",
      networkAccess: "Źródła sieciowe",
      hostTools: "Narzędzia i dane hosta",
      activeCapabilities: "Aktywne uprawnienia widżetu",
      networkCapability: "Sieć: {capability}",
      toolCapability: "Narzędzie: {capability}",
      granted: "Przyznano",
      allow: "Zezwól",
      reject: "Odrzuć",
      rejected: "Odmówiono dostępu",
      rejectedDetail:
        "Ten widżet pozostaje nieaktywny, dopóki nie zostanie usunięty lub zastąpiony.",
      appLoading: "Przywracanie aplikacji…",
      appStaleTitle: "Ta przypięta aplikacja jest nieaktualna",
      appStaleDetail: "Jej serwer, zasób lub źródłowy transkrypt nie jest już dostępny.",
      retry: "Ponów",
      frameResolverMissing: "Zawartość widżetu jest niedostępna.",
      sandboxUnavailable: "Host piaskownicy widżetów jest niedostępny.",
      frameAuthorizationFailed:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia.",
      sandboxOriginRequired:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia. Jeśli Gateway działa za reverse proxy lub tunelem, który nie kieruje ruchu do portu piaskownicy widżetów, ustaw mcp.apps.sandboxOrigin na dedykowane publiczne pochodzenie kierowane do nasłuchu piaskownicy.",
      errorTitle: "Nie można załadować tego widżetu",
      errorDetail: "Problem dotyczy tylko tej karty.",
      actionErrorTitle: "Zmiana widżetu nie powiodła się",
      actionErrorDetail: "Pulpit zachował poprzedni stan widżetu.",
  ...
  workboard: {
    widget: {
      cardLabel: "Karta Workboard",
      summaryLabel: "Podsumowanie Workboard",
      loading: "Ładowanie Workboard…",
      cardIdRequired: "Ten widget wymaga właściwości cardId.",
      cardMissing: "Ta karta Workboard nie jest już dostępna.",
      unassigned: "Nieprzypisane",
      openBoard: "Otwórz tablicę",
      statusCounts: "Karty według statusu",
      noActiveCards: "Brak gotowych lub uruchomionych kart.",
    },
    ...
    dashboardEmpty: "Brak pulpitu — pracujący agent może przypiąć widgety.",
    openSession: "Otwórz sesję",
  ...
  usage: {
    ...
    details: {
      ...
      loadFailed: "Nie udało się wczytać {detail}: {error}",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      loadFailed: "Nie udało się załadować żądania parowania tej przeglądarki: {error}",
      approvalFailed: "Nie udało się zabezpieczyć tej przeglądarki: {error}",
    },
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Wątek przełączył gałęzie — przejrzyj i wyślij ponownie.",
    },
    waitingForApproval: "Oczekiwanie na zatwierdzenie…",
    startupStatus: {
      preparingWorkspace: "Przygotowywanie przestrzeni roboczej…",
      provisioningEnvironment: "Przydzielanie środowiska…",
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Tylko właściciel i członkowie wątku mogą w nim działać.",
    },
    sessionSuggestions: {
      suggest: "Zaproponuj",
      suggestMessage: "Zaproponuj wiadomość",
      attachmentsUnsupported: "Usuń załączniki przed przesłaniem propozycji tekstowej.",
      sendNow: "Wyślij teraz propozycję od {author}",
      queue: "Dodaj do kolejki propozycję od {author}",
      edit: "Edytuj propozycję od {author}",
      dismiss: "Odrzuć propozycję od {author}",
      typing: "{name} pisze…",
    ...
    sessionHeader: {
      ...
      copied: "Skopiowano",
      incognito: "Wątek incognito",
      branches: "Odgałęzienia wątku",
      branchSwitchUnavailable: "Przełączanie odgałęzień jest niedostępne, gdy agent pracuje.",
      branchSwitchRequiresAdmin: "Przełączanie gałęzi wymaga dostępu administratora operatora.",
      untitledBranch: "Gałąź bez tytułu",
      oneMessage: "{count} wiadomość",
      messages: "{count} wiadomości",
      activeBranch: "Aktywna gałąź",
    },
    board: {
      faceLabel: "Widok wątku",
      chatFace: "Czat",
      dashboardFace: "Panel",
      dockMenu: "Dok czatu: {dock}",
      dockLeft: "Zadokuj czat po lewej",
      dockRight: "Zadokuj czat po prawej",
      dockBottom: "Zadokuj czat na dole",
      dockHidden: "Ukryj czat",
      resizeDock: "Zmień rozmiar doku czatu",
      reopenChat: "Pokaż czat",
      workboardCard: "Karta tablicy roboczej: {title}, {status}",
      defaultTab: "Główna",
      mockPlaceholder: "Widok tablicy · {tabs} kart · {widgets} widżetów",
      mockOverview: "Przegląd",
      mockResearch: "Badania",
      mockSessionStatus: "Status wątku",
      mockRecentFindings: "Ostatnie ustalenia",
      mockSourceMap: "Mapa źródeł",
      resetTitle: "Zresetować rozmowę?",
      resetDescription: "Kontekst rozmowy zostanie zresetowany. Pulpit pozostanie bez zmian.",
    },
    catalog: {
    ...
    catalogOpenTarget: "Otwieraj sesje zewnętrzne w",
    ...
    workspaceConflict: {
      ...
      titleMany: "{count} konfliktów obszaru roboczego w chmurze",
      description:
        "OpenClaw zachował Twoje lokalne wersje i zastosował pozostałe zmiany z chmury. Sprawdź wynik przygotowany do scalenia lub przejmij wersję z chmury dla konfliktowej ścieżki.",
      morePaths: "+{count} dodatkowych ścieżek",
      stagedResult: "Przygotowany wynik z chmury",
      copyStagedResult: "Kopiuj referencję przygotowanego wyniku",
      inspectCloud: "Sprawdź pierwszą wersję z chmury",
      takeCloud: "Przejmij pierwszą wersję z chmury",
      copyInspectCommand: "Kopiuj polecenie inspekcji chmury",
      copyTakeCommand: "Kopiuj polecenie przejęcia wersji z chmury",
      commandHelp:
        "Uruchom je w Bash lub zsh (Git Bash w systemie Windows). Jeśli inspekcja informuje, że ścieżka nie istnieje, chmura ją usunęła; zweryfikuj i usuń ścieżkę lokalną ręcznie. Jeśli checkout zgłasza konflikt pliku/katalogu, przenieś lub usuń blokującą ścieżkę lokalną, a następnie spróbuj ponownie. Jeśli brakuje przygotowanej referencji, powiadomienie jest nieaktualne; nie zmieniaj ścieżki lokalnej.",
      commandsUnavailable:
        "Ta nazwa pliku zawiera znaki sterujące terminala, więc OpenClaw nie utworzy dla niej możliwego do skopiowania polecenia powłoki. Sprawdź przygotowaną referencję bezpośrednio i wprowadź ścieżkę ręcznie z zachowaniem ostrożności.",
      dismiss: "Odrzuć powiadomienie o konflikcie obszaru roboczego",
      eventSender: "Obszar roboczy w chmurze",
      eventTitleOne: "Zastosowano wynik z chmury z 1 konfliktem",
      eventTitleMany: "Zastosowano wynik z chmury z {count} konfliktami",
      eventDescription:
        "Wersje lokalne zostały zachowane dla tych ścieżek; inne zmiany z chmury zostały zastosowane.",
    },
    compaction: {
    ...
    progressLabels: {
      shelling: "Skorupienie",
      scuttling: "Dreptanie",
      clawing: "Pazurkowanie",
      pinching: "Uszczypywanie",
      molting: "Linienie",
      bubbling: "Bąbelkowanie",
      tiding: "Falowanie",
      reefing: "Rafowanie",
      cracking: "Pękanie",
      sifting: "Przesiewanie",
      brining: "Solankowanie",
      nautiling: "Nautilusowanie",
      krilling: "Krylowanie",
      barnacling: "Pąklowanie",
      lobstering: "Homarowanie",
      tidepooling: "Kałużowanie",
      pearling: "Perłowanie",
      snapping: "Kłapanie",
      surfacing: "Wynurzanie",
    },
    turnRecap: {
      doneIn: "Ukończono w {duration}",
    ...
    sidebar: {
      ...
      updateMacAndGateway: "Zaktualizuj aplikację na Maca i Gateway",
    ...
    questions: {
      ...
      skipping: "Pomijanie…",
      skipped: "Pominięte",
      collapse: "Zwiń pytanie",
      expand: "Rozwiń pytanie",
      eyebrow: "Pytanie",
      cardLabel: "Pytanie od asystenta",
      summaryLabel: "Wynik pytania",
      timeRemaining: "Pozostały czas",
      ownAnswer: "Twoja własna odpowiedź…",
      ownAnswerFor: "Twoja własna odpowiedź dla {header}",
      submitting: "Wysyłanie…",
      submitFailed: "Nie można wysłać: {error}",
      answered: "Odpowiedziano",
      answeredElsewhere: "Odpowiedziano gdzie indziej",
      unavailable: "Niedostępne",
      expired: "Wygasł",
      cancelled: "Anulowano",
    },
    ...
    messages: {
      ...
      hideTooltip: "Ukryj tylko w tej przeglądarce",
      openInCanvas: "Otwórz w kanwie",
      reply: "Odpowiedz",
      replyToMessage: "Odpowiedz na wiadomość",
      replyingTo: "Odpowiadasz {name}",
      rewind: "Cofnij",
      rewindConfirm: "Cofnąć do stanu sprzed tej wiadomości?",
      rewindToHere: "Cofnij do tego miejsca",
      rewindUnavailable: "Cofanie jest niedostępne, gdy agent pracuje",
      forkUnavailable: "Rozgałęzianie jest niedostępne, gdy agent pracuje",
    ...
    rail: {
      ...
      subtitle: "Zapytaj o tę sesję lub jej projekt",
      expand: "Rozwiń panel sesji",
      collapse: "Zwiń panel sesji",
      hide: "Ukryj panel sesji",
      show: "Pokaż panel sesji",
      clear: "Wyczyść wątek asystenta",
      plan: "Plan",
      progress: "{completed} z {total}",
      pullRequests: "Pull requesty",
      checksPassing: "{count} zaliczonych",
      checksFailing: "{count} niezaliczonych",
      checksPending: "{count} w toku",
      finished: "Zakończono {time}",
      empty: "Zadaj pytanie tylko do odczytu o tej sesji lub jej projekcie.",
      askLabel: "Zapytaj asystenta sesji",
      askPlaceholder: "Co powinienem wiedzieć?",
      askSubmit: "Pytaj",
      askPending: "Sprawdzanie sesji…",
      askBusy: "Asystent już odpowiada na pytanie.",
      askUnavailable: "Asystent nie może teraz odpowiedzieć.",
      asOf: "na dzień {time}",
      health: {
        "on-track": "Na dobrej drodze",
        grinding: "Pracuję",
        stuck: "Utknąłem",
        "waiting-on-user": "Czekam na Ciebie",
        "wrapping-up": "Kończę",
        done: "Gotowe",
        failed: "Niepowodzenie",
      },
    ...
    observer: {
      ...
      plan: "Plan",
      progress: "{completed} z {total}",
      boardCurrentStatus: "Bieżący status",
      boardTimeline: "Oś czasu kondycji",
      boardCurrentRun: "Bieżące uruchomienie",
      boardPreviousRun: "Poprzednie uruchomienie",
      boardUnknownRun: "Niezidentyfikowany przebieg",
      boardSinceYouLeft: "Od Twojego wyjścia",
      health: {
        "on-track": "Na dobrej drodze",
        grinding: "Pracuję",
        stuck: "Utknąłem",
    ...
    composer: {
      ...
      cameraAccessFailed: "Nie można uzyskać dostępu do kamery.",
      cameraBusy: "Kamera jest zajęta lub niedostępna dla przeglądarki.",
      cameraFallback: "Kamera {number}",
      cameraInput: "Kamera",
      cameraListUnsupported: "Ta przeglądarka nie może wyświetlić listy kamer.",
      cameraNoneFound: "Nie znaleziono kamery.",
      cameraPageInactive: "Kamery są niedostępne, gdy ta strona jest nieaktywna.",
      ...
      microphoneAppliesNextSession:
        "Zmiany zostaną zastosowane po rozpoczęciu następnej sesji Talk.",
      microphoneListUnsupported: "Ta przeglądarka nie może wyświetlić listy wejść mikrofonu.",
      noCameras: "Nie znaleziono dodatkowych kamer",
      ...
      holdToRecordSetting: "Przytrzymaj przycisk mikrofonu, aby dyktować",
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w edytorze, mów, a następnie zwolnij, aby wstawić tekst bez wysyłania.",
      dictationAudioUnsupported: "Gateway zwrócił nieobsługiwany format dźwięku dyktowania.",
      dictationBrowserAudioUnsupported:
        "Ta przeglądarka nie może przechwytywać dźwięku dyktowania w 8 kHz.",
      dictationConnecting: "Rozpoczynanie dyktowania…",
      dictationDisconnected: "Dyktowanie zatrzymane, ponieważ Gateway się rozłączył.",
      dictationFailed: "Dyktowanie nie powiodło się.",
      dictationFinalizing: "Kończenie dyktowania…",
      dictationFinalizationTimedOut:
        "Dyktowanie zatrzymane, zanim udało się sfinalizować ostatnią częściową transkrypcję.",
      dictationProviderUnavailable: "Nie skonfigurowano dostawcy transkrypcji dla dyktowania.",
      dictationRecording: "Nagrywanie {elapsed}",
      dictationReleaseToInsert: "Zwolnij, aby wstawić dyktowanie",
      ...
      selectedCameraUnavailable:
        "Wybrana kamera jest niedostępna. Wybierz inną kamerę lub Domyślną systemową.",
      ...
      systemDefaultCamera: "Domyślne systemowe",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Ten widżet musi zostać ponownie wyrenderowany, aby wyeksportować go jako obraz.",
      widgetExportFailed: "Eksport widżetu nie powiódł się. Spróbuj ponownie.",
      pinToDashboard: "Przypnij do panelu",
      pinToDashboardPending: "Przypinanie…",
      pinnedToDashboard: "Przypięte",
    ...
    backgroundTasks: {
      ...
      expandTask: "Pokaż szczegóły zadania {title}",
      detailTitle: "Szczegóły zadania",
      backToTasks: "Powrót do zadań w tle",
      detailLoading: "Ładowanie szczegółów zadania…",
      detailFailed: "Nie udało się załadować szczegółów zadania.",
      prompt: "Polecenie",
      output: "Dane wyjściowe",
      promptUnavailable: "Polecenie jest niedostępne.",
      outputPending: "Brak danych wyjściowych.",
    },
    sessionDiff: {
      title: "Zmiany",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Do otwarcia tej dyskusji wymagany jest dostęp operatora do zapisu.",
      openExternal: "Otwórz dyskusję w nowej karcie",
      frameTitle: "Dyskusja sesji",
      unavailable: "Tej dyskusji nie można osadzić.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Uruchamia się co sekundę",
      ...
      summaryEverySeconds: "Uruchamia się co {amount} sekund",
