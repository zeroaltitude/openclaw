...
export const vi: TranslationMap = {
  common: {
    ...
    refresh: "Làm mới",
    retry: "Thử lại",
    staleData: "Đang hiển thị dữ liệu cũ.",
    reload: "Tải lại",
    reset: "Đặt lại",
    restore: "Khôi phục",
  ...
  channels: {
    ...
    hub: {
      connectedTitle: "Kênh của bạn",
      addTitle: "Thêm kênh",
      addSubtitle: "Chọn một dịch vụ và làm theo hướng dẫn thiết lập.",
      updatedAgo: "Đã cập nhật {ago}",
      noneConnected: "Chưa có kênh nào được kết nối. Chọn một kênh bên dưới để bắt đầu.",
      partialSnapshot: "Một số lượt kiểm tra kênh chưa hoàn tất trong thời gian cho phép của UI.",
      stateRunning: "Đang chạy",
      stateConfigured: "Đã cấu hình",
      stateAttention: "Cần chú ý",
      setUp: "Thiết lập",
      guidedSetup: "Hướng dẫn thiết lập từng bước",
      openDetails: "Mở chi tiết",
      lastMessageAgo: "Tin nhắn gần nhất {ago}",
      browseAllTitle: "Thêm kênh…",
      browseAllSubtitle: "Duyệt tất cả các kênh hiện có, bao gồm cả plugin có thể cài đặt.",
      runSetup: "Chạy thiết lập",
      saveBeforeSetup:
        "Bạn có các thay đổi cấu hình kênh chưa được lưu. Hãy lưu hoặc tải lại trước khi chạy thiết lập có hướng dẫn.",
    },
    pairing: {
      title: "Yêu cầu truy cập DM",
      subtitle:
        "Xem xét những người đang chờ gửi tin nhắn trực tiếp đến các kênh được bảo vệ bằng ghép nối.",
      channelFilter: "Kênh",
      accountFilter: "Tài khoản",
      allChannels: "Tất cả kênh",
      allAccounts: "Tất cả tài khoản",
      approve: "Chấp thuận",
      dismiss: "Bỏ qua",
      approveAria: "Chấp thuận {sender} cho {channel}, tài khoản {account}",
      dismissAria: "Bỏ qua {sender} cho {channel}, tài khoản {account}",
      requested: "Đã yêu cầu {ago}",
      expires: "Hết hạn {ago}",
      senderDetails: "Chi tiết người gửi",
      missingPermission:
        "Kết nối này không có quyền truy cập operator.pairing, nên không thể xem xét yêu cầu DM.",
      noAccounts: "Không có tài khoản kênh nào được cấu hình sử dụng ghép nối người gửi DM.",
      noRequests: "Không có yêu cầu truy cập DM đang chờ.",
      noFilteredRequests: "Không có yêu cầu đang chờ nào khớp với các bộ lọc này.",
      limits:
        "Yêu cầu hết hạn sau {minutes} phút. Mỗi tài khoản kênh có thể giữ tối đa {count} yêu cầu đang chờ.",
      detailTitle: "Truy cập DM",
      detailSubtitle:
        "Mọi người phải được phê duyệt trước khi tin nhắn trực tiếp của họ đến được với agent.",
      pendingCount: "{count} đang chờ",
      noPending: "Không có yêu cầu nào đang chờ",
      review: "Xem xét yêu cầu",
      approveDialogTitle: "Phê duyệt quyền truy cập DM",
      dismissDialogTitle: "Bỏ qua yêu cầu truy cập DM",
      approveExplanation:
        "Điều này cho phép người gửi trò chuyện với agent trong tin nhắn trực tiếp. Nó không cấp quyền truy cập nhóm.",
      dismissExplanation:
        "Điều này xóa yêu cầu hiện tại nhưng không chặn người gửi. Họ có thể yêu cầu quyền truy cập lại sau.",
      notifyRequester: "Thông báo cho người yêu cầu sau khi phê duyệt",
      makeCommandOwner: "Đồng thời đặt người gửi này làm chủ sở hữu lệnh đầu tiên",
      commandOwnerHelp:
        "Chủ sở hữu lệnh có thể chạy các lệnh đặc quyền và phê duyệt các hành động nguy hiểm. Tùy chọn này chỉ khả dụng khi chưa cấu hình chủ sở hữu nào.",
      commandOwnerNeedsAdmin:
        "Chưa cấu hình chủ sở hữu lệnh nào. Kết nối này cần operator.admin để chỉ định chủ sở hữu đầu tiên.",
      approvedNotice: "Đã phê duyệt quyền truy cập DM.",
      approvedOwnerNotice: "Đã phê duyệt quyền truy cập DM và cấu hình chủ sở hữu lệnh đầu tiên.",
      approvedNotificationFailedNotice:
        "Đã phê duyệt quyền truy cập DM, nhưng không thể gửi thông báo cho người yêu cầu.",
      approvedOwnerFailedNotice:
        "Đã phê duyệt quyền truy cập DM, nhưng không thể cấu hình chủ sở hữu lệnh đầu tiên.",
      approvedFollowupsFailedNotice:
        "Đã phê duyệt quyền truy cập DM, nhưng cả thông báo cho người yêu cầu và thiết lập chủ sở hữu lệnh đều thất bại.",
      dismissedNotice:
        "Đã bỏ qua yêu cầu truy cập DM. Người gửi có thể yêu cầu quyền truy cập lại.",
    },
    setup: {
      dialogLabel: "Thiết lập {channel}",
      title: "Thiết lập {channel}",
      genericTitle: "một kênh",
      subtitle: "Thiết lập nhanh có hướng dẫn — bạn có thể tinh chỉnh mọi thứ sau.",
      starting: "Đang bắt đầu thiết lập…",
      working: "Đang làm việc…",
      sessionExpired:
        "Phiên thiết lập này đã hết hạn sau khi Gateway khởi động lại. Đóng hộp thoại này, sau đó bắt đầu lại thiết lập kênh.",
      continue: "Tiếp tục",
      finish: "Hoàn tất",
      copyText: "Sao chép",
      ...
      whatsappQrLoading: "Đang tạo mã QR…",
      whatsappQrHint: "Nhấp vào Hiển thị mã QR để tạo mã ghép nối.",
      whatsappLinked: "WhatsApp đã được liên kết và sẵn sàng.",
      regenerateQr: "Mã QR mới",
      linkLater: "Liên kết sau",
    },
    config: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào được lưu bị xóa. Có thể phiên đã không còn tồn tại, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Chưa có ứng dụng?",
      getApps: "Tải ứng dụng",
  ...
  agentChip: {
    ...
    agents: "Tác nhân",
    openChat: "Trò chuyện với {name}",
    offlineOpenSettings: "Ngoại tuyến — mở Cài đặt",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud worker yêu cầu runtime OpenClaw; {runtime} đang được chọn.",
    ...
    places: "Địa điểm",
    recentFolders: "Gần đây",
    runsOn: "Chạy trên {place}",
    ...
    worktree: "Worktree",
    checkingGit: "Đang kiểm tra tính khả dụng của Git…",
    gitCheckUnavailable: "Không thể xác minh Git cho thư mục này. Chọn lại để thử lần nữa.",
  ...
  sessionsView: {
    ...
    global: "Toàn cục",
    unknown: "Không rõ",
    sessionState: "Trạng thái luồng",
    all: "Tất cả",
    sessionArchived: "Đã lưu trữ luồng",
    sessionsArchived: "Đã lưu trữ {count} luồng",
    deleteAllArchived: "Xóa tất cả đã lưu trữ…",
    deleteAllArchivedConfirm: "Xóa {count} luồng đã lưu trữ và bản ghi của chúng?",
    ...
    runFailedReason: "Chạy thất bại: {reason}",
    ...
    showChildSessions: "Hiển thị {count} phiên con của {session}",
    hideChildSessions: "Ẩn {count} phiên con của {session}",
    childSessions: "Phiên con",
    showMoreChildren: "Hiển thị thêm {count}",
    archived: "Đã lưu trữ",
    pinned: "Đã ghim",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Con của cloud worker: 1 xung đột không gian làm việc",
    cloudWorkerDescendantConflicts: "Con của cloud worker: {count} xung đột không gian làm việc",
    ...
    customEmoji: "Emoji tùy chỉnh",
    invalidEmojiIcon: "Nhập chính xác một emoji.",
  ...
  configForm: {
    ...
    advancedHidden: "Đã ẩn {count} cài đặt nâng cao",
    advancedHiddenPlural: "Đã ẩn {count} cài đặt nâng cao",
    advancedDivider: "Nâng cao",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Hồ sơ gateway của bạn",
      ...
      profileHint: "JPEG, PNG hoặc WebP. Hình ảnh được cắt ở giữa và đổi kích thước về 512px.",
      profileLoadFailed: "Không thể tải hồ sơ của bạn.",
      profileSaveFailed: "Không thể lưu hồ sơ của bạn.",
      avatarInvalid: "Chọn một hình ảnh JPEG, PNG hoặc WebP hợp lệ.",
      avatarTooLarge: "Ảnh đại diện đã xử lý vẫn còn quá lớn.",
  ...
  configView: {
    categories: {
      ...
      security: "Quyền riêng tư & Bảo mật",
      automation: "Tự động hóa",
    ...
    notifications: {
      ...
      nativeHint: "Thông báo được hiển thị nguyên bản bởi ứng dụng OpenClaw trên máy Mac này.",
      ...
      nativeBlockedHint:
        "Thông báo đã bị tắt cho OpenClaw trong macOS. Cho phép chúng trong System Settings > Notifications.",
    },
    appearance: {
      theme: "Giao diện",
    ...
    chatPrefs: {
      ...
      messageWidthInvalid:
        "Nhập chiều rộng CSS chẳng hạn như 960px, 82%, min(1280px, 82%) hoặc calc(100% - 2rem).",
    },
    sidebarPrefs: {
      title: "Thanh bên",
      hint: "Chọn nội dung hiển thị khi các phiên đang chạy.",
      liveActivity: "Hiển thị hoạt động trực tiếp của agent trong thanh bên",
      liveActivityHint:
        "Hiển thị hoạt động mới nhất của trợ lý hoặc công cụ bên dưới các phiên đang chạy.",
    },
    sessionObserver: {
      title: "Trình quan sát phiên",
      hint: "Tóm tắt các phiên chạy dài bằng một mô hình tiện ích nhỏ.",
      toggle: "Trình quan sát phiên",
      toggleHint: "Tạo bản tóm tắt trạng thái trực tiếp cho các phiên Control UI đã đăng ký.",
      resolvedModel: "Mô hình nhỏ đã phân giải",
      modelAuto: "tự động ({model})",
      modelConfigured: "đã cấu hình ({model})",
      modelDisabled: "đã tắt",
      modelUnavailable: "không khả dụng (không có mô hình nhỏ)",
      modelPicker: "Mô hình nhỏ",
      modelPickerHint: "Dùng cho bản tóm tắt của trình quan sát và các tác vụ tiện ích ngắn khác.",
      modelCatalogUnavailable: "Danh mục mô hình rõ ràng không khả dụng",
      auto: "Tự động (mặc định của nhà cung cấp)",
      disabled: "Đã tắt",
      toggleNote: "Cập nhật trình quan sát phiên Control UI",
      modelNote: "Cập nhật mô hình tiện ích mặc định",
    },
    connection: {
      title: "Kết nối",
      gateway: "Gateway",
    ...
    rawDiscard: "Loại bỏ",
    rawDraftBlocksApply:
      "Có thay đổi cấu hình thô chưa lưu — hãy lưu hoặc hủy chúng trong trình chỉnh sửa Raw trước khi khởi động lại.",
    rawDraftPendingFormTitle:
      "Có thay đổi cấu hình thô chưa lưu — hãy lưu hoặc hủy chúng trước khi chuyển sang Form.",
    rawDraftBlocksFormEdit:
      "Không thể phân tích các thay đổi cấu hình thô chưa lưu; hãy giải quyết chúng trong trình chỉnh sửa Raw trước khi thay đổi cài đặt.",
    invalidConfig:
    ...
    formUnsafeCount: "1 cài đặt trong cấu hình này chỉ có thể chỉnh sửa dưới dạng văn bản: {paths}",
    formUnsafeCountPlural:
      "{count} cài đặt trong cấu hình này chỉ có thể chỉnh sửa dưới dạng văn bản: {paths}",
    formUnsafeMore: "+{count} nữa",
    openRawEditor: "Mở trình chỉnh sửa Raw",
  ...
  execApproval: {
    ...
    otherPending: "Các yêu cầu đang chờ khác",
    reviewRequest: "Xem xét phê duyệt từ {agent}: {command}",
    agentPendingOne: "{count} phê duyệt đang chờ xử lý",
    agentPending: "{count} phê duyệt đang chờ xử lý",
  ...
  terminal: {
    ...
    noSessions: "Không có phiên terminal đang hoạt động",
    currentSession: "hiện tại",
    sessionAttached: "đã kết nối",
  ...
  subtitles: {
    ...
    apps: "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt.",
    ...
    modelSetup: "Kết nối một mô hình AI đã được xác minh",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Đưa bộ nhớ của Codex và Claude Code vào không gian làm việc của tác nhân.",
    notifications: "Thông báo đẩy trình duyệt từ gateway của bạn.",
    security: "Xác thực Gateway, chính sách thực thi, hồ sơ công cụ và phê duyệt.",
    advanced: "Mọi phần cấu hình còn lại, cùng với trình chỉnh sửa tệp thô.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      recommended: "Đề xuất",
      credentialsReady: "Thông tin xác thực đã sẵn sàng",
      signInNeeded: "Cần đăng nhập",
      detected: "Đã phát hiện",
      testAndUse: "Kiểm tra và sử dụng",
    ...
    failure: {
      ...
      rateLimit: "Đã vượt giới hạn tần suất",
      billing: "Vấn đề thanh toán",
      timeout: "Đã hết thời gian chờ",
      format: "Phản hồi không hợp lệ",
      unavailable: "Không khả dụng",
      unknown: "Kết nối không thành công",
    },
    errors: {
      requestFailed: "Yêu cầu thiết lập mô hình không thành công.",
      activationFailed: "Không thể kích hoạt mô hình.",
    },
    wizard: {
      dialogLabel: "Đăng nhập nhà cung cấp",
      prepareDialogLabel: "Thiết lập mô hình cục bộ",
      title: "Đăng nhập bằng nhà cung cấp",
      prepareTitle: "Thiết lập một mô hình cục bộ",
      ...
      copy: "Sao chép",
      expires: "Hết hạn sau {count} phút",
      cancelled: "Đã hủy đăng nhập nhà cung cấp.",
      sessionExpired:
        "Phiên thiết lập này đã hết hạn sau khi Gateway khởi động lại. Đóng hộp thoại này, sau đó bắt đầu thiết lập mô hình lại.",
      notComplete: "Đã đăng nhập xong, nhưng quá trình thiết lập mô hình vẫn chưa hoàn tất.",
    },
  },
  memoryImport: {
    unknownCollection: "Bộ sưu tập bộ nhớ",
    claudeCode: "Claude Code",
    fileCountOne: "{count} tệp",
    fileCount: "{count} tệp",
    alreadyImported: "{count} mục hiện có",
    ready: "Sẵn sàng",
    existing: "Hiện có",
    importComplete: "Nhập hoàn tất",
    importIncomplete: "Nhập chưa hoàn tất",
    importedCount: "Đã nhập {count} tệp",
    importedWithIssues: "Đã nhập {migrated} · {errors} thất bại · {conflicts} xung đột",
    reportSaved: "đã lưu báo cáo",
    recoveryFile: "Tệp khôi phục",
    recoveryJournal: "Nhật ký khôi phục",
    itemBackup: "Bản sao lưu mục",
    codexDescription: "Các tệp bộ nhớ Codex đã hợp nhất.",
    claudeDescription: "Các tệp bộ nhớ tự động theo từng dự án của Claude Code.",
    providerFallback: "Nhập bộ nhớ của trợ lý vào không gian làm việc của tác nhân này.",
    reviewFiles: "Xem lại tệp",
    notFound: "Không tìm thấy",
    noMemoryFound: "Không tìm thấy bộ nhớ có thể nhập trên máy tính này.",
    source: "Nguồn",
    destination: "Đích đến",
    selectedCount: "Đã chọn {count}",
    selectAtLeastOne: "Chọn ít nhất một tệp",
    importSelected: "Nhập mục đã chọn",
    confirmTitle: "Nhập từ {provider}?",
    confirmDescription:
  ...
  custodian: {
    ...
    subtitleCaretaker: "Thiết lập và bảo trì hệ thống.",
    exitSetup: "Thoát thiết lập",
    newAgent: "Agent mới",
    hatchDraft: "Dậy thôi, bạn của tôi!",
    placeholder: "Nhắn tin cho OpenClaw…",
    sensitivePlaceholder: "Nhập giá trị nhạy cảm…",
    sensitiveReply: "Đã gửi trả lời nhạy cảm",
    send: "Gửi",
    thinking: "OpenClaw đang suy nghĩ",
    earlier: "Trước đó",
    requestFailed: "OpenClaw không thể trả lời. Hãy thử lại.",
    connectionChanged: "Kết nối Gateway đã thay đổi. Hãy thử lại để tiếp tục thiết lập này.",
    sessionRestarted:
      "{error} OpenClaw đã bắt đầu một phiên mới; các tin nhắn trước đó vẫn được giữ lại làm ngữ cảnh.",
    unsupportedGateway: "Cập nhật Gateway để tiếp tục thiết lập với OpenClaw.",
    history: {
      button: "Lịch sử",
      title: "Thay đổi gần đây",
      description: "Những gì đã thay đổi trên hệ thống này, mới nhất trước.",
      loading: "Đang tải thay đổi gần đây…",
      empty: "Chưa có thay đổi nào được ghi lại.",
      requestFailed: "OpenClaw không thể tải lịch sử thay đổi.",
      loadMore: "Tải thêm",
      loadingMore: "Đang tải thêm…",
      changedPaths: "Đường dẫn đã thay đổi ({count})",
      invalidEdit: "Chỉnh sửa thủ công này không vượt qua kiểm tra xác thực cấu hình.",
      opaqueChange:
        "Định dạng hoặc chú thích đã thay đổi mà không có thay đổi đường dẫn cấu hình rõ ràng.",
      sources: {
    ...
    nudge: {
      configReload: "Việc tải lại cấu hình đã dừng — hãy hỏi tôi chuyện gì đã xảy ra",
      channelAuth: "Xác thực {channel} bị suy giảm — hãy hỏi tôi chuyện gì đã xảy ra",
      channelDisconnected: "{channel} vừa ngắt kết nối — hãy hỏi tôi chuyện gì đã xảy ra",
  ...
  mcpServers: {
    ...
    addedSuccess: "Đã thêm máy chủ MCP {name}.",
    enabledSuccess: "Đã bật máy chủ MCP {name}.",
    disabledSuccess: "Đã tắt máy chủ MCP {name}.",
    removedSuccess: "Đã xóa máy chủ MCP {name}.",
    configUnavailable: "Cấu hình hiện không khả dụng; hãy làm mới và thử lại.",
    connectRequired: "Kết nối với gateway để thay đổi các máy chủ MCP.",
    adminRequired: "Việc thay đổi máy chủ MCP yêu cầu quyền truy cập operator.admin.",
    enable: "Bật",
    disable: "Tắt",
  ...
  mcpPage: {
    connectorsLink: "Khám phá các trình kết nối một-cú-nhấp trên trang Plugins.",
    servers: "Máy chủ",
    oauth: "OAuth",
    filtered: "Đã lọc",
  ...
  labsPage: {
    intro:
      "Labs chứa các tính năng thử nghiệm có thể thay đổi, hỏng hoặc biến mất giữa các phiên bản.",
    sectionTitle: "Tính năng thử nghiệm",
    sectionDescription:
      "Các thay đổi được lưu ngay lập tức và áp dụng cho các lần chạy agent trong tương lai.",
    documentation: "Tài liệu",
    restartRequired: "Cần khởi động lại Gateway.",
    saveErrorTitle: "Không thể cập nhật tính năng",
    saveFailed: "Không thể lưu cài đặt tính năng.",
    codeMode: {
      title: "Chế độ Code",
      description:
        "Cho phép tác nhân kết hợp công cụ trong các quy trình JavaScript nhỏ gọn, được cách ly an toàn.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "Mang OpenClaw đến mọi nơi",
    heroTagline:
      "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng các plugin để mở rộng khả năng của tác nhân.",
    sectionMobile: "Trên điện thoại của bạn",
    havePhone: "Đã có ứng dụng?",
    pairDevice: "Ghép nối thiết bị của bạn",
    sectionWatch: "Trên cổ tay của bạn",
    sectionDesktop: "Trên máy tính của bạn",
    sectionBrowser: "Trong trình duyệt của bạn",
    sectionCommunity: "Cộng đồng",
    badgeBundledIos: "Đi kèm với ứng dụng iOS",
    badgeBundledAndroid: "Đi kèm với ứng dụng Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Tải xuống",
    ctaDocs: "Tài liệu",
    ctaSetupGuide: "Hướng dẫn thiết lập",
    ctaOpenPlugins: "Mở Plugins",
    ctaBrowseClawHub: "Duyệt ClawHub",
    linkDiscord: "Cộng đồng Discord",
    linkDocs: "Tài liệu",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Trò chuyện, nói chuyện, phê duyệt hành động và chia sẻ vào OpenClaw từ iOS.",
      },
      android: {
        title: "Android",
        desc: "Điện thoại Android của bạn như một node OpenClaw đầy đủ — trò chuyện, camera và Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Trò chuyện dễ xem và trả lời nhanh ngay trên cổ tay bạn.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Ứng dụng đồng hành Android mở rộng OpenClaw đến đồng hồ của bạn.",
      },
      macos: {
        title: "macOS",
        desc: "Ứng dụng đồng hành trên thanh menu cho Gateway của bạn — thông báo, phê duyệt, trò chuyện nhanh.",
      },
      windows: {
        title: "Windows",
        desc: "Ứng dụng đồng hành Windows kết nối PC của bạn như một node OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Ứng dụng desktop gốc — bản dựng .deb và AppImage.",
      },
      chrome: {
        title: "Tiện ích mở rộng Chrome",
        desc: "Cho phép OpenClaw điều khiển Chrome hiện có của bạn — thẻ, trang và biểu mẫu.",
      },
      plugins: {
        title: "Plugin & ClawHub",
        desc: "Mở rộng OpenClaw với các kênh, công cụ và Skills từ cộng đồng.",
      },
    },
  },
  presence: {
    rosterLabel: "Hiển thị ai đang trực tuyến",
    rosterTitle: "Trực tuyến",
  ...
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Danh tính chưa được thiết lập.",
      setIdentity: "Thiết lập danh tính",
      avatar: "Ảnh đại diện",
      avatarDescription:
        "PNG, JPEG hoặc WebP. Hình ảnh được đổi kích thước xuống 256 × 256 hoặc nhỏ hơn.",
      chooseAvatar: "Chọn hình ảnh",
      processingAvatar: "Đang xử lý…",
      displayName: "Tên hiển thị",
      displayNameDescription: "Hiển thị cho những người khác đang dùng gateway này.",
      linkedEmails: "Email đã liên kết",
      linkedEmailsDescription: "Các địa chỉ email được kết nối với hồ sơ này.",
      openSettings: "Mở cài đặt danh tính cho {name}",
      avatarErrors: {
        invalid: "Không thể xử lý hình ảnh đó.",
        sourceTooLarge: "Hãy chọn hình ảnh có dung lượng 10 MB hoặc nhỏ hơn.",
        tooLarge: "Ảnh đại diện đã xử lý lớn hơn 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  skillWorkshop: {
    ...
    history: {
      eyebrow: "Công việc trước đây",
      title: "Tìm quy trình làm việc có thể tái sử dụng",
      body: "Xem lại các phiên quan trọng từ mới nhất đến cũ nhất. Chỉ những mẫu khôi phục hiệu quả hoặc quy trình giúp giảm số lần gọi công cụ lặp lại mới trở thành đề xuất đang chờ xử lý.",
      findIdeas: "Tìm ý tưởng kỹ năng",
      scanEarlier: "Quét công việc trước đó",
      scanNew: "Quét công việc mới",
      scanning: "Đang xem lại các phiên…",
      loading: "Đang tải lịch sử…",
      pendingOnly: "Chỉ các đề xuất đang chờ xử lý · sử dụng mô hình bạn đã cấu hình",
      reviewed: "Đã xem lại {count} phiên",
      found: "Đã tìm thấy {count} ý tưởng",
      noSessions: "Không tìm thấy phiên quan trọng nào trong khoảng thời gian này.",
      today: "hôm nay",
    },
    today: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Tự động theo dõi",
    file: "Tệp: {file}",
    truncated: "Đầu ra nhật ký đã bị cắt bớt; đang hiển thị đoạn mới nhất.",
  ...
  board: {
    label: "Bảng điều khiển luồng",
    tabsLabel: "Các thẻ bảng điều khiển",
    moreTabs: "Thêm thẻ bảng điều khiển",
    gridLabel: "Tiện ích bảng điều khiển",
    emptyTitle: "Một bảng trống, sẵn sàng làm việc",
    emptyHint:
      "Tác nhân của bạn có thể ghim tiện ích tại đây — hãy thử yêu cầu một thẻ trạng thái.",
    actionFailed: "Không thể lưu thay đổi bảng điều khiển.",
    actionInProgress: "Một thay đổi bảng điều khiển khác vẫn đang được lưu.",
    announcement: {
      moved: "Đã di chuyển {title}.",
      resized: "Đã đổi kích thước {title}.",
      removed: "Đã xóa {title}.",
      granted: "Đã cho phép truy cập widget.",
      rejected: "Đã từ chối truy cập widget.",
    },
    widget: {
      cellLabel:
        "Widget bảng điều khiển: {title}. Dùng phím mũi tên để điều hướng. Giữ Alt và nhấn phím mũi tên để di chuyển.",
      moveHandle: "Di chuyển {title}",
      resizeHandle: "Đổi kích thước {title}",
      menuLabel: "Tùy chọn widget",
      moveToTab: "Chuyển đến tab",
      noOtherTabs: "Không có tab nào khác",
      resize: "Đổi kích thước",
      autoHeight: "Chiều cao tự động",
      remove: "Xóa",
      needsApproval: "Cần phê duyệt",
      needsApprovalDetail: "Widget này đã yêu cầu quyền truy cập bổ sung.",
      networkAccess: "Nguồn gốc mạng",
      hostTools: "Công cụ và dữ liệu máy chủ",
      activeCapabilities: "Khả năng widget đang hoạt động",
      networkCapability: "Mạng: {capability}",
      toolCapability: "Công cụ: {capability}",
      granted: "Đã cấp",
      allow: "Cho phép",
      reject: "Từ chối",
      rejected: "Đã từ chối truy cập",
      rejectedDetail: "Widget này sẽ không hoạt động cho đến khi bị xóa hoặc thay thế.",
      appLoading: "Đang khôi phục ứng dụng…",
      appStaleTitle: "Ứng dụng đã ghim này đã cũ",
      appStaleDetail: "Máy chủ, tài nguyên hoặc bản ghi gốc của nó không còn khả dụng.",
      retry: "Thử lại",
      frameResolverMissing: "Nội dung widget không khả dụng.",
      sandboxUnavailable: "Máy chủ sandbox của widget không khả dụng.",
      frameAuthorizationFailed: "Ủy quyền widget thất bại sau nhiều lần thử làm mới.",
      sandboxOriginRequired:
        "Ủy quyền widget thất bại sau nhiều lần thử làm mới. Nếu gateway chạy phía sau reverse proxy hoặc tunnel không định tuyến cổng sandbox của widget, hãy đặt mcp.apps.sandboxOrigin thành một origin công khai chuyên dụng được định tuyến đến trình lắng nghe sandbox.",
      errorTitle: "Không thể tải widget này",
      errorDetail: "Sự cố chỉ giới hạn ở thẻ này.",
      actionErrorTitle: "Thay đổi widget thất bại",
      actionErrorDetail: "Bảng điều khiển giữ nguyên trạng thái widget trước đó.",
      errorShow: "Hiển thị chi tiết",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Đang tải widget plugin…",
      disabledPlugin: "Widget từ plugin đã tắt {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "Thẻ Workboard",
      summaryLabel: "Tóm tắt Workboard",
      loading: "Đang tải Workboard…",
      cardIdRequired: "Widget này cần thuộc tính cardId.",
      cardMissing: "Thẻ Workboard này không còn khả dụng.",
      unassigned: "Chưa gán",
      openBoard: "Mở bảng",
      statusCounts: "Thẻ theo trạng thái",
      noActiveCards: "Không có thẻ nào sẵn sàng hoặc đang chạy.",
    },
    ...
    dashboardEmpty: "Chưa có bảng điều khiển — tác nhân đang làm việc có thể ghim widget.",
    openSession: "Mở phiên",
  ...
  modelProviders: {
    ...
    credentials: {
      ...
      envKey: "Khóa API từ môi trường",
      envKeyNamed: "Khóa API từ môi trường ({name})",
      profileKey: "Hồ sơ khóa API: {count}",
      none: "Chưa cấu hình",
    },
    apiKey: {
      label: "Khóa API",
      placeholder: "Nhập khóa API của nhà cung cấp",
      replacePlaceholder: "Đã lưu thông tin bí mật. Nhập khóa mới để thay thế.",
      set: "Đặt khóa API",
      replace: "Thay thế khóa",
      remove: "Xóa khóa",
      saved: "Đã lưu thông tin bí mật.",
      removed: "Đã xóa khóa API.",
      authModeBlocked: 'Không thể thay đổi khóa API khi chế độ xác thực là "{mode}".',
    },
    probe: {
      test: "Kiểm tra kết nối",
      testing: "Đang kiểm tra…",
      unavailable: "Kiểm tra kết nối yêu cầu phiên bản Gateway mới hơn.",
      latency: "{ms} ms",
      status: {
        ok: "Đã kết nối",
        auth: "Xác thực không thành công",
        rate_limit: "Đã đạt giới hạn tần suất",
        billing: "Có vấn đề về thanh toán",
        timeout: "Đã hết thời gian chờ",
        format: "Phản hồi không hợp lệ",
        unknown: "Kết nối không thành công",
    ...
    logout: {
      action: "Đăng xuất",
      confirm: "Đăng xuất khỏi {provider}? Các hồ sơ OAuth và token đã lưu sẽ bị xóa.",
      loggingOut: "Đang đăng xuất…",
      done: "Đã đăng xuất.",
    },
    add: {
      title: "Thêm nhà cung cấp",
      subtitle: "Chọn một nhà cung cấp mô hình đã biết và lưu khóa API của nhà cung cấp đó.",
      action: "Thêm nhà cung cấp",
      none: "Tất cả nhà cung cấp đã biết đều đã được cấu hình.",
      provider: "Nhà cung cấp",
      selectProvider: "Chọn nhà cung cấp",
      save: "Lưu nhà cung cấp",
      saved: "Đã thêm nhà cung cấp {provider}.",
    },
    defaults: {
      title: "Mô hình mặc định",
      subtitle: "Chọn mô hình chính, các mô hình dự phòng theo thứ tự và mô hình tiện ích.",
      primary: "Mô hình mặc định",
      utility: "Mô hình tiện ích",
      automatic: "Tự động (mặc định của nhà cung cấp)",
      disabled: "Đã tắt",
      savedSelection: "Lựa chọn đã lưu",
      fallbacks: "Dự phòng",
      noFallbacks: "Chưa cấu hình mô hình dự phòng.",
      unsaved: "Thay đổi chưa lưu",
      addFallback: "Thêm mô hình dự phòng",
      selectModel: "Chọn một mô hình",
      selectFallback: "Chọn một mô hình dự phòng",
      noModels: "Hãy cấu hình một nhà cung cấp trước khi chọn mô hình mặc định.",
      saved: "Đã lưu các mô hình mặc định.",
    },
    readOnly: {
      disconnected: "Kết nối với Gateway để thay đổi cài đặt mô hình.",
      adminRequired:
        "Chỉ có thể duyệt xem. Việc thay đổi mô hình yêu cầu quyền truy cập operator.admin.",
    },
    notes: {
      saveKey: "Lưu khóa API cho {provider} từ Control UI",
      removeKey: "Xóa khóa API cho {provider} khỏi Control UI",
      addProvider: "Thêm nhà cung cấp mô hình {provider} từ Control UI",
      defaultModel: "Cập nhật lựa chọn mô hình mặc định từ Control UI",
    },
  },
  usage: {
    common: {
    ...
    details: {
      ...
      loadFailed: "Không thể tải {detail}: {error}",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Trình duyệt cũ này tạm thời vẫn khả dụng. Mở lại qua HTTPS hoặc localhost để bảo mật bằng danh tính thiết bị.",
      pendingUnavailable: "Yêu cầu ghép nối trình duyệt chưa khả dụng. Hãy thử lại sau giây lát.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Luồng đã chuyển nhánh — hãy xem lại và gửi lại.",
    },
    waitingForApproval: "Đang chờ phê duyệt…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      suggest: "Đề xuất",
      draft: "Bản nháp",
      publishDraft: "Đăng bản nháp",
      members: "Thành viên",
      selected: "Thành viên",
      noPeople: "Không tìm thấy người đã ghép nối.",
      readOnlyNotice: "Chỉ chủ luồng và thành viên mới có thể thao tác trong luồng này.",
    },
    sessionSuggestions: {
      suggest: "Đề xuất",
      suggestMessage: "Đề xuất tin nhắn",
      attachmentsUnsupported: "Xóa tệp đính kèm trước khi gửi đề xuất văn bản.",
      sendNow: "Gửi đề xuất của {author} ngay",
    ...
    sessionHeader: {
      ...
      renameAria: "Đổi tên phiên {title}",
      renameInputAria: "Tiêu đề phiên",
      renameInputPlaceholder: "Tiêu đề phiên",
      workspaceAria: "Thao tác workspace cho {workspace}",
      revealFinder: "Hiển thị trong Finder",
      revealFileExplorer: "Hiển thị trong File Explorer",
      revealFileManager: "Mở trong trình quản lý tệp",
      copyPath: "Sao chép đường dẫn",
      copyBranch: "Sao chép tên nhánh",
      copied: "Đã sao chép",
      incognito: "Luồng ẩn danh",
      ...
      untitledBranch: "Nhánh chưa đặt tên",
    ...
    board: {
      faceLabel: "Mặt luồng",
      chatFace: "Trò chuyện",
      dashboardFace: "Bảng điều khiển",
      dockMenu: "Neo trò chuyện: {dock}",
      dockLeft: "Neo trò chuyện bên trái",
      dockRight: "Neo trò chuyện bên phải",
      dockBottom: "Neo trò chuyện phía dưới",
      dockHidden: "Ẩn trò chuyện",
      resizeDock: "Đổi kích thước khung trò chuyện",
      reopenChat: "Hiện trò chuyện",
      workboardCard: "Thẻ bảng công việc: {title}, {status}",
      defaultTab: "Chính",
      mockPlaceholder: "Điểm nối chế độ xem bảng · {tabs} tab · {widgets} widget",
      mockOverview: "Tổng quan",
      mockResearch: "Nghiên cứu",
      mockSessionStatus: "Trạng thái luồng",
      mockRecentFindings: "Phát hiện gần đây",
      mockSourceMap: "Source map",
      resetTitle: "Đặt lại cuộc trò chuyện?",
      resetDescription:
        "Ngữ cảnh cuộc trò chuyện sẽ được đặt lại. Bảng điều khiển của bạn vẫn giữ nguyên.",
    },
    catalog: {
    ...
    followUpModeServer: "Mặc định của máy chủ ({mode})",
    followUpModeLoading: "đang tải…",
    ...
    workspaceConflict: {
      titleOne: "1 xung đột không gian làm việc đám mây",
      titleMany: "{count} xung đột không gian làm việc đám mây",
      description:
        "OpenClaw đã giữ lại các phiên bản cục bộ của bạn và áp dụng các thay đổi đám mây khác. Kiểm tra kết quả đã dàn dựng hoặc lấy phiên bản của nó cho đường dẫn bị xung đột.",
      morePaths: "+{count} đường dẫn khác",
      stagedResult: "Kết quả đám mây đã dàn dựng",
      copyStagedResult: "Sao chép ref kết quả đã dàn dựng",
      inspectCloud: "Kiểm tra phiên bản đám mây đầu tiên",
      takeCloud: "Lấy phiên bản đám mây đầu tiên",
      copyInspectCommand: "Sao chép lệnh kiểm tra đám mây",
      copyTakeCommand: "Sao chép lệnh lấy-đám-mây",
      commandHelp:
        "Chạy các lệnh này trong Bash hoặc zsh (Git Bash trên Windows). Nếu inspect báo đường dẫn không tồn tại, tức là đám mây đã xóa nó; hãy xác minh và xóa đường dẫn cục bộ theo cách thủ công. Nếu checkout báo xung đột tệp/thư mục, hãy di chuyển hoặc xóa đường dẫn cục bộ đang chặn, rồi thử lại. Nếu thiếu ref đã dàn dựng, thông báo đã cũ; đừng thay đổi đường dẫn cục bộ.",
      commandsUnavailable:
        "Tên tệp này chứa các ký tự điều khiển terminal, nên OpenClaw sẽ không tạo lệnh shell có thể sao chép cho nó. Hãy kiểm tra ref đã dàn dựng trực tiếp và nhập đường dẫn thủ công một cách cẩn thận.",
      dismiss: "Bỏ qua thông báo xung đột không gian làm việc",
      eventSender: "Không gian làm việc đám mây",
      eventTitleOne: "Kết quả đám mây đã áp dụng với 1 xung đột",
      eventTitleMany: "Kết quả đám mây được áp dụng với {count} xung đột",
      eventDescription:
        "Các phiên bản cục bộ đã được giữ lại cho những đường dẫn này; các thay đổi đám mây khác đã được áp dụng.",
    },
    compaction: {
    ...
    progressLabels: {
      shelling: "Đang tạo vỏ",
      scuttling: "Đang chạy lon ton",
      clawing: "Đang giương càng",
      pinching: "Đang kẹp",
      molting: "Đang lột xác",
      bubbling: "Đang sủi bọt",
      tiding: "Đang theo thủy triều",
      reefing: "Đang khám phá rạn san hô",
      cracking: "Đang phá vỡ",
      sifting: "Đang sàng lọc",
      brining: "Đang ngâm nước muối",
      nautiling: "Đang hóa ốc anh vũ",
      krilling: "Đang bắt tôm moi",
      barnacling: "Đang bám như hà",
      lobstering: "Đang bắt tôm hùm",
      tidepooling: "Đang khám phá hồ thủy triều",
      pearling: "Đang tìm ngọc trai",
      snapping: "Đang búng càng",
      surfacing: "Đang nổi lên",
    },
    turnRecap: {
      doneIn: "Hoàn tất trong {duration}",
      tokens: "{count} token",
      tokensOne: "1 token",
    },
    commands: {
    ...
    questions: {
      ...
      eyebrow: "Câu hỏi",
      cardLabel: "Câu hỏi từ trợ lý",
      summaryLabel: "Kết quả câu hỏi",
      timeRemaining: "Thời gian còn lại",
      ownAnswer: "Câu trả lời của riêng bạn…",
      ownAnswerFor: "Câu trả lời của riêng bạn cho {header}",
      submitting: "Đang gửi…",
      submitFailed: "Không thể gửi: {error}",
      answered: "Đã phản hồi",
      answeredElsewhere: "Đã được trả lời ở nơi khác",
      unavailable: "Không khả dụng",
      expired: "Đã hết hạn",
      cancelled: "Đã hủy",
    },
    imageLightbox: {
      label: "Xem trước hình ảnh: {title}",
      open: "Mở hình ảnh {title}",
      openOriginal: "Mở bản gốc",
      close: "Đóng xem trước hình ảnh",
      untitled: "Hình ảnh",
    },
    messages: {
      activity: "Hoạt động",
      ...
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Tác nhân vẫn thấy nó.",
      hideMessage: "Ẩn tin nhắn",
      hideTooltip: "Chỉ ẩn trong trình duyệt này",
      ...
      rewindUnavailable: "Không thể tua lại khi tác nhân đang làm việc",
      forkUnavailable: "Không thể rẽ nhánh khi tác nhân đang làm việc",
      showLess: "Thu gọn",
      showMore: "Xem thêm",
    ...
    modelControls: {
      ...
      reasoning: "Lập luận",
      speed: "Tốc độ",
      sessionOverride: "Ghi đè luồng",
      usingDefault: "Đang dùng mặc định từ Cài đặt",
      resetToDefault: "Đặt lại về mặc định ({model})",
    },
    rail: {
      title: "Trợ lý phiên",
      subtitle: "Hỏi về phiên này hoặc dự án của nó",
      expand: "Mở rộng thanh phiên",
      collapse: "Thu gọn thanh phiên",
      hide: "Ẩn thanh phiên",
      show: "Hiện thanh phiên",
      clear: "Xóa luồng trợ lý",
      plan: "Kế hoạch",
      progress: "{completed} trên {total}",
      pullRequests: "Pull request",
      checksPassing: "{count} đạt",
      checksFailing: "{count} thất bại",
      checksPending: "{count} đang chạy",
      finished: "Hoàn tất {time}",
      empty: "Đặt câu hỏi chỉ đọc về phiên này hoặc dự án của nó.",
      askLabel: "Hỏi trợ lý phiên",
      askPlaceholder: "Tôi cần biết điều gì?",
      askSubmit: "Hỏi",
      askPending: "Đang kiểm tra phiên…",
      askBusy: "Trợ lý đang trả lời một câu hỏi khác.",
      askUnavailable: "Trợ lý không thể trả lời ngay lúc này.",
      asOf: "tính đến {time}",
      health: {
        "on-track": "Đúng hướng",
        grinding: "Đang làm việc",
        stuck: "Bị kẹt",
        "waiting-on-user": "Đang chờ bạn",
    ...
    observer: {
      ...
      plan: "Kế hoạch",
      progress: "{completed} trên {total}",
      boardCurrentStatus: "Trạng thái hiện tại",
      boardTimeline: "Dòng thời gian tình trạng",
      boardCurrentRun: "Lần chạy hiện tại",
      boardPreviousRun: "Lần chạy trước",
      boardUnknownRun: "Lần chạy không xác định",
      boardSinceYouLeft: "Kể từ khi bạn rời đi",
      health: {
        "on-track": "Đúng hướng",
        grinding: "Đang làm việc",
        stuck: "Bị kẹt",
    ...
    composer: {
      ...
      offlineQueuedHint: "Ngoại tuyến — {count} đang chờ; tin nhắn sẽ gửi khi có kết nối trở lại.",
      ...
      takePhoto: "Chụp ảnh",
      cameraAccessFailed: "Không thể truy cập máy ảnh.",
      cameraBusy: "Máy ảnh đang bận hoặc không khả dụng với trình duyệt.",
      cameraFallback: "Máy ảnh {number}",
      cameraInput: "Máy ảnh",
      cameraListUnsupported: "Trình duyệt này không thể liệt kê máy ảnh.",
      cameraNoneFound: "Không tìm thấy máy ảnh.",
      cameraPageInactive: "Máy ảnh không khả dụng khi trang này không hoạt động.",
      cameraPermissionBlocked:
        "Quyền truy cập máy ảnh bị chặn. Cho phép truy cập máy ảnh và micro trong cài đặt trang web của trình duyệt.",
      cameraPreview: "Xem trước máy ảnh",
      ...
      microphoneAppliesNextSession: "Thay đổi sẽ áp dụng khi bạn bắt đầu phiên Talk tiếp theo.",
      microphoneListUnsupported: "Trình duyệt này không thể liệt kê đầu vào micrô.",
      noCameras: "Không tìm thấy máy ảnh nào khác",
      ...
      holdToRecordSetting: "Giữ nút micrô để đọc chính tả",
      holdToRecordSettingDescription:
        "Giữ nút micrô của trình soạn thảo, nói, rồi thả ra để chèn văn bản mà không gửi.",
      dictationAudioUnsupported:
        "Gateway đã trả về định dạng âm thanh đọc chính tả không được hỗ trợ.",
      dictationBrowserAudioUnsupported: "Trình duyệt này không thể thu âm đọc chính tả ở 8 kHz.",
      dictationConnecting: "Đang bắt đầu đọc chính tả…",
      dictationDisconnected: "Đọc chính tả đã dừng vì Gateway bị ngắt kết nối.",
      dictationFailed: "Đọc chính tả thất bại.",
      dictationFinalizing: "Đang hoàn tất đọc chính tả…",
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi phần bản ghi cuối cùng được hoàn tất.",
      dictationProviderUnavailable: "Chưa cấu hình nhà cung cấp phiên âm cho đọc chính tả.",
      dictationRecording: "Đang ghi {elapsed}",
      dictationReleaseToInsert: "Thả ra để chèn nội dung đọc chính tả",
      ...
      selectedCameraUnavailable:
        "Camera đã chọn không khả dụng. Hãy chọn camera khác hoặc mặc định hệ thống.",
      ...
      systemDefaultCamera: "Mặc định hệ thống",
    ...
    toolCards: {
      ...
      widgetActions: "Hành động widget",
      copyToClipboard: "Sao chép vào clipboard",
      downloadFile: "Tải tệp xuống",
      widgetExportRerender: "Widget này cần được kết xuất lại để xuất thành hình ảnh.",
      widgetExportFailed: "Xuất widget thất bại. Hãy thử lại.",
      pinToDashboard: "Ghim vào bảng điều khiển",
      pinToDashboardPending: "Đang ghim…",
      pinnedToDashboard: "Đã ghim",
    ...
    backgroundTasks: {
      ...
      expandTask: "Hiển thị chi tiết về {title}",
      detailTitle: "Chi tiết tác vụ",
      backToTasks: "Quay lại tác vụ nền",
      detailLoading: "Đang tải chi tiết tác vụ…",
      detailFailed: "Không thể tải chi tiết tác vụ.",
      prompt: "Lời nhắc",
      output: "Kết quả",
      promptUnavailable: "Không có lời nhắc.",
      outputPending: "Chưa có kết quả.",
    },
    sessionDiff: {
      title: "Thay đổi",
    ...
    sessionDiscussion: {
      ...
      opening: "Đang mở thảo luận…",
      requiresWriteAccess: "Cần quyền ghi của người vận hành để mở thảo luận này.",
      openExternal: "Mở thảo luận trong tab mới",
      frameTitle: "Thảo luận phiên",
      unavailable: "Không thể nhúng thảo luận này.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Payload này được tạo bên ngoài Control UI. Nội dung của nó ở chế độ chỉ đọc và được giữ nguyên khi bạn lưu các thay đổi khác.",
