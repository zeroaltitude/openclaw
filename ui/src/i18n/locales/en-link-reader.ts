...
const enLinkReader = {
  linkReader: {
    ...
    checks: "Checks",
    checksSuccess: "Checks passed",
    checksFailure: "Checks failed",
    checksPending: "Checks in progress",
    checksNeutral: "Checks",
    checksUnavailable: "Checks unavailable",
    checkSuccess: "Passed",
    checkFailure: "Failed",
    checkPending: "In progress",
    checkNeutral: "Neutral",
    checksTruncated: "Some checks could not be shown. Open the source for the complete results.",
    checksSource: "View all checks",
    checksCommit: "Checks for commit {commit}",
    filesShort: "Files",
