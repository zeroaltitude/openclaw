// Frozen reader from refs/tags/v2026.9.4:src/commands/triage-update.ts.
// Only the writer is omitted; retain released schema and bounds.
...
type TriageUpdateFailure = z.infer<typeof updateFailureSchema>;

function sanitizeTriageUpdateFailure(
  input: unknown,
...
export async function readReleasedTriageUpdateFailure(
  inputPath: string,
  redaction: SupportRedactionContext,
