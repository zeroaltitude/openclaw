...
import type { TaskScopeKind } from "./task-registry.types.js";
...
export function assertParentFlowRecordLinkAllowed(
  params: { ownerKey: string; scopeKind: TaskScopeKind; parentFlowId?: string },
