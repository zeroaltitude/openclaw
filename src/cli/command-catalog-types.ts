// Leaf contracts for the declarative CLI command catalog, shared by the catalog, its
// supervision entries, and startup policy resolution without importing the catalog itself.
