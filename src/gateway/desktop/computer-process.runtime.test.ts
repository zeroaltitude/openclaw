...
it("runs a synthetic provider through the private worker and finalizes its execution before exiting", async () => {
...
`,
  ...
  try {
    ...
    await child.close({ executionId, reason: "completion" });
  }
