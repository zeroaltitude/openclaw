    ...
    for (const payload of payloads) {
      ...
      if (shouldRouteToOriginating) {
        const result = await routeReply({
          ...
          requesterSenderId: queued.run.senderId ?? undefined,
          requesterSenderName: queued.run.senderName ?? undefined,
          requesterSenderUsername: queued.run.senderUsername ?? undefined,
          requesterSenderE164: queued.run.senderE164 ?? undefined,
