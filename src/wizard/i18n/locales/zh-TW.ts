...
export const zh_TW = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      authTokenMode: "你想如何儲存 Gateway 密鑰？",
      authTokenStoredMessage: "這個 Gateway 密鑰存在哪裡？",
      ...
      plaintextTokenLabel: "產生/儲存明文密鑰",
      port: "Gateway 連接埠",
      refHint: "儲存參照而不是明文",
      refLabel: "使用 SecretRef",
      remoteTokenMode: "你想如何提供這個 Gateway 密鑰？",
    ...
    remote: {
      ...
      gatewayTokenStoredMessage: "這個 Gateway 密鑰存在哪裡？",
      insecureRemoteUrl:
      ...
      plaintextTokenHint: "將密鑰直接儲存在 OpenClaw 設定中",
      plaintextTokenLabel: "現在輸入密鑰",
      searchProgress: "正在搜尋 Gateway...",
      selectGateway: "選擇 Gateway",
      sshTunnel: "SSH 通道（loopback）",
      sshTunnelTitle: "SSH 通道",
      secretPlaceholder: "留空以保留現有密鑰或不使用密鑰繼續",
      keepSecretConfirm: "保留現有 Gateway 密鑰？",
      noSecretConfirm: "不使用 Gateway 密鑰繼續？",
      tokenPrompt: "Gateway 密鑰",
