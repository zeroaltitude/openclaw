...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      authTokenMode: "How do you want to store the Gateway secret?",
      authTokenStoredMessage: "Where is this Gateway secret stored?",
    ...
    remote: {
      ...
      secretPlaceholder: "Leave blank to keep an existing secret or continue without one",
      keepSecretConfirm: "Keep the existing Gateway secret?",
      noSecretConfirm: "Continue without a Gateway secret?",
      tokenPrompt: "Gateway secret",
